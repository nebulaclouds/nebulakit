...
from nebulakit import NebulaContext, kwtypes
...
class SQLite3Config(object):
    ...
    Args:
        uri: default NebulaFile that will be downloaded on execute
...
class SQLite3Task(PythonCustomizedContainerTask[SQLite3Config], SQLTask[SQLite3Config]):
    """
    Run client side SQLite3 queries that optionally return a NebulaSchema object.
    ...
    .. literalinclude:: ../../../tests/nebulakit/unit/extras/sqlite3/test_task.py
    ...
    the base class :py:class:`nebulakit.extend.PythonCustomizedContainerTask` as well.
    """
    ...
    def __init__(
        ...
        output_schema_type: typing.Optional[typing.Type["NebulaSchema"]] = None,  # type: ignore
        ...
        **kwargs,
        ...
        outputs = kwtypes(results=output_schema_type if output_schema_type else NebulaSchema)
        super().__init__(
            name=name,

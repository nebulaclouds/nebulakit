...
from nebulakit.core.type_engine import T, TypeEngine, TypeTransformer
...
class PandasDataFrameTransformer(TypeTransformer[pandas.DataFrame]):
    ...
    def to_python_value(
        self, ctx: NebulaContext, lv: Literal, expected_python_type: Type[pandas.DataFrame]
    ) -> pandas.DataFrame:
    ...
    def to_html(self, ctx: NebulaContext, python_val: pandas.DataFrame, expected_python_type: Type[T]):

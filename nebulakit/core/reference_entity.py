...
from nebulakit.core.context_manager import BranchEvalMode, ExecutionState, NebulaContext
...
class ReferenceEntity(object):
    ...
    def local_execute(self, ctx: NebulaContext, **kwargs) -> Optional[Union[Tuple[Promise], Promise, VoidPromise]]:
        """
...
# nebulakit.models.common.NebulaIdlEntity.
class ReferenceTemplate(object):
    def __init__(self, id: _identifier_model.Identifier, resource_type: int) -> None:
        ...
        :param nebulakit.models.core.identifier.Identifier id: User-specified information that uniquely
            identifies this reference.
        :param int resource_type: The type of reference. See: nebulakit.models.core.identifier.ResourceType
        """
        self._id = id
    ...
    def resource_type(self) -> int:
        ...
        :rtype: nebulakit.models.core.identifier.ResourceType
        """

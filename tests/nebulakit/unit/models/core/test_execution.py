...
from nebulakit.models.core import execution
...
def test_task_logs():
    ...
    obj2 = execution.TaskLog.from_nebula_idl(obj.to_nebula_idl())
    assert obj2 == obj
...
def test_execution_error():
    ...
    obj2 = execution.ExecutionError.from_nebula_idl(obj.to_nebula_idl())
    assert obj == obj2

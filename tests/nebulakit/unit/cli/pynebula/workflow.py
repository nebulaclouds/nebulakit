...
def print_all(
    ...
    l: dict,
    m: dict,
    n: typing.List[typing.Dict[str, NebulaFile]],
    o: typing.Dict[str, typing.List[NebulaFile]],
    p: typing.Any,
    q: NebulaDirectory,
):
...
@task
def test_union1(a: typing.Union[int, NebulaFile, typing.Dict[str, float], datetime.datetime, Color]):
    print(a)

...
from nebulakit.models.core import execution as _core_exec
from nebulakit.models.core import identifier as _identifier
from tests.nebulakit.common import parameterizers as _parameterizers
...
def test_execution_closure_with_output():
    ...
    obj2 = _execution.ExecutionClosure.from_nebula_idl(obj.to_nebula_idl())
    assert obj2 == obj
...
def test_system_metadata():
    ...
    obj2 = _execution.SystemMetadata.from_nebula_idl(obj.to_nebula_idl())
    assert obj == obj2
...
def test_execution_metadata():
    ...
    obj2 = _execution.ExecutionMetadata.from_nebula_idl(obj.to_nebula_idl())
    assert obj == obj2
...
def test_execution_spec(literal_value_pair):
    ...
    obj2 = _execution.ExecutionSpec.from_nebula_idl(obj.to_nebula_idl())
    assert obj == obj2
...
def test_workflow_execution_data_response():
    ...
    obj2 = _execution.WorkflowExecutionGetDataResponse.from_nebula_idl(obj.to_nebula_idl())
    assert obj == obj2
...
def test_node_execution_data_response():
    ...
    obj2 = _execution.NodeExecutionGetDataResponse.from_nebula_idl(obj.to_nebula_idl())
    assert obj == obj2
    assert obj2.inputs == input_blob
    assert obj2.outputs == output_blob
    assert obj2.full_inputs == _INPUT_MAP
...
def test_task_execution_data_response():
    ...
    obj2 = _execution.TaskExecutionGetDataResponse.from_nebula_idl(obj.to_nebula_idl())
    assert obj == obj2
    assert obj2.inputs == input_blob
    assert obj2.outputs == output_blob
    assert obj2.full_inputs == _INPUT_MAP
...
def test_abort_metadata():
    ...
    obj2 = _execution.AbortMetadata.from_nebula_idl(obj.to_nebula_idl())
    assert obj == obj2

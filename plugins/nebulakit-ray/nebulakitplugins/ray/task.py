...
import ray
from nebulakitplugins.ray.models import HeadGroupSpec, RayCluster, RayJob, WorkerGroupSpec
...
class RayFunctionTask(PythonFunctionTask):
    ...
    def get_custom(self, settings: SerializationSettings) -> Optional[Dict[str, Any]]:
        ...
        return MessageToDict(ray_job.to_nebula_idl())


# Inject the Ray plugin into nebulakits dynamic plugin loading system

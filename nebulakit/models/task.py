...
from nebulaidl.admin import task_pb2 as _admin_task
from nebulaidl.core import compiler_pb2 as _compiler
from nebulaidl.core import literals_pb2 as _literals_pb2
from nebulaidl.core import tasks_pb2 as _core_task
...
class Resources(_common.NebulaIdlEntity):
    ...
    class ResourceEntry(_common.NebulaIdlEntity):
        ...
        def to_nebula_idl(self):
            """
            :rtype: nebulaidl.core.tasks_pb2.ResourceEntry
            """
        ...
        def from_nebula_idl(cls, pb2_object):
            """
            :param nebulaidl.core.tasks_pb2.Resources.ResourceEntry pb2_object:
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.tasks_pb2.Resources
        """
        return _core_task.Resources(
            requests=[r.to_nebula_idl() for r in self.requests],
            limits=[r.to_nebula_idl() for r in self.limits],
        )
    ...
    def from_nebula_idl(cls, pb2_object):
        ...
        """
        return cls(
            requests=[Resources.ResourceEntry.from_nebula_idl(r) for r in pb2_object.requests],
            limits=[Resources.ResourceEntry.from_nebula_idl(l) for l in pb2_object.limits],
        )


class RuntimeMetadata(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.tasks_pb2.RuntimeMetadata
        """
...
class TaskMetadata(_common.NebulaIdlEntity):
    def __init__(
        ...
        :param nebulakit.models.literals.RetryStrategy retries: Retry strategy for this task.  0 retries means only
            try once.
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.admin.task_pb2.TaskMetadata
        """
        tm = _core_task.TaskMetadata(
            discoverable=self.discoverable,
            runtime=self.runtime.to_nebula_idl(),
    ...
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.core.task_pb2.TaskMetadata pb2_object:
        :rtype: TaskMetadata
        """
        return cls(
            discoverable=pb2_object.discoverable,
            runtime=RuntimeMetadata.from_nebula_idl(pb2_object.runtime),
            ...
            retries=_literals.RetryStrategy.from_nebula_idl(pb2_object.retries),
...
class TaskTemplate(_common.NebulaIdlEntity):
    def __init__(
        self,
        id,
        type,
        ...
        """
        A task template represents the full set of information necessary to perform a unit of work in the Nebula system.
        It contains the metadata about what inputs and outputs are consumed or produced.  It also contains the metadata
        necessary for Nebula Propeller to do the appropriate work.

        :param nebulakit.models.core.identifier.Identifier id: This is generated by the system and uniquely identifies
            the task.
        ...
        :param nebulakit.models.interface.TypedInterface interface: The interface definition for this task.
        ...
        :param Sql sql: This is used to execute query in NebulaPropeller instead of running container or k8s_pod.
        :param nebulaidl.core.tasks_pb2.ExtendedResources extended_resources: The extended resources to allocate to the task.
        """
        if (
    ...
    def extended_resources(self):
        ...
        :rtype: nebulaidl.core.tasks_pb2.ExtendedResources
        """
        return self._extended_resources

    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.tasks_pb2.TaskTemplate
        """
        task_template = _core_task.TaskTemplate(
            ...
            container=self.container.to_nebula_idl() if self.container else None,
            ...
            k8s_pod=self.k8s_pod.to_nebula_idl() if self.k8s_pod else None,
            sql=self.sql.to_nebula_idl() if self.sql else None,
        )
    ...
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.core.tasks_pb2.TaskTemplate pb2_object:
        :rtype: TaskTemplate
        """
        return cls(
            id=_identifier.Identifier.from_nebula_idl(pb2_object.id),
            type=pb2_object.type,
            metadata=TaskMetadata.from_nebula_idl(pb2_object.metadata),
            ...
            container=Container.from_nebula_idl(pb2_object.container) if pb2_object.HasField("container") else None,
            task_type_version=pb2_object.task_type_version,
            security_context=_sec.SecurityContext.from_nebula_idl(pb2_object.security_context)
            ...
            k8s_pod=K8sPod.from_nebula_idl(pb2_object.k8s_pod) if pb2_object.HasField("k8s_pod") else None,
            sql=Sql.from_nebula_idl(pb2_object.sql) if pb2_object.HasField("sql") else None,
        )


class TaskSpec(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.admin.tasks_pb2.TaskSpec
        """
        return _admin_task.TaskSpec(
            template=self.template.to_nebula_idl(), description=self.docs.to_nebula_idl() if self.docs else None
        )

    @classmethod
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.admin.tasks_pb2.TaskSpec pb2_object:
        :rtype: TaskSpec
        """
        return cls(
            TaskTemplate.from_nebula_idl(pb2_object.template),
            Documentation.from_nebula_idl(pb2_object.description) if pb2_object.description else None,
        )


class Task(_common.NebulaIdlEntity):
    def __init__(self, id, closure):
        """
        :param nebulakit.models.core.identifier.Identifier id: The (project, domain, name) identifier for this task.
    ...
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.admin.task_pb2.Task pb2_object:
        :rtype: TaskDefinition
        """
        return cls(
            closure=TaskClosure.from_nebula_idl(pb2_object.closure),
            id=_identifier.Identifier.from_nebula_idl(pb2_object.id),
        )


class TaskClosure(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.admin.task_pb2.TaskClosure
        """
        return _admin_task.TaskClosure(compiled_task=self.compiled_task.to_nebula_idl())

    @classmethod
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.admin.task_pb2.TaskClosure pb2_object:
        :rtype: TaskClosure
        """
        return cls(compiled_task=CompiledTask.from_nebula_idl(pb2_object.compiled_task))
...
class CompiledTask(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        ...
        """
        return _compiler.CompiledTask(template=self.template.to_nebula_idl())

    @classmethod
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.core.compiler_pb2.CompiledTask pb2_object:
        :rtype: CompiledTask
        """
        return cls(template=TaskTemplate.from_nebula_idl(pb2_object.template))


class IOStrategy(_common.NebulaIdlEntity):
    """
    ...
    def to_nebula_idl(self) -> _core_task.IOStrategy:
        return _core_task.IOStrategy(download_mode=self._download_mode, upload_mode=self._upload_mode)

    @classmethod
    def from_nebula_idl(cls, pb2_object: _core_task.IOStrategy):
...
class DataLoadingConfig(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self) -> _core_task.DataLoadingConfig:
        return _core_task.DataLoadingConfig(
            input_path=self._input_path,
            output_path=self._output_path,
            format=self._format,
            enabled=self._enabled,
            io_strategy=self._io_strategy.to_nebula_idl() if self._io_strategy is not None else None,
        )

    @classmethod
    def from_nebula_idl(cls, pb2: _core_task.DataLoadingConfig) -> "DataLoadingConfig":
        if pb2 is None:
            return None
        return cls(
            ...
            enabled=pb2.enabled,
            format=pb2.format,
            io_strategy=IOStrategy.from_nebula_idl(pb2.io_strategy) if pb2.HasField("io_strategy") else None,
        )


class Container(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.tasks_pb2.Container
        """
        return _core_task.Container(
            image=self.image,
            command=self.command,
            args=self.args,
            resources=self.resources.to_nebula_idl(),
            ...
            data_config=self._data_loading_config.to_nebula_idl() if self._data_loading_config else None,
        )
    ...
    def from_nebula_idl(cls, pb2_object):
        ...
        return cls(
            ...
            data_loading_config=DataLoadingConfig.from_nebula_idl(pb2_object.data_config)
            if pb2_object.HasField("data_config")
            else None,
        )


class K8sObjectMetadata(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self) -> _core_task.K8sObjectMetadata:
    ...
    @classmethod
    def from_nebula_idl(cls, pb2_object: _core_task.K8sObjectMetadata):
        return cls(
...
class K8sPod(_common.NebulaIdlEntity):
    def __init__(
        self,
    ...
    def to_nebula_idl(self) -> _core_task.K8sPod:
        return _core_task.K8sPod(
            metadata=self._metadata.to_nebula_idl(),
            pod_spec=_json_format.Parse(_json.dumps(self.pod_spec), _struct.Struct()) if self.pod_spec else None,
            data_config=self.data_config.to_nebula_idl() if self.data_config else None,
        )

    @classmethod
    def from_nebula_idl(cls, pb2_object: _core_task.K8sPod):
        return cls(
            metadata=K8sObjectMetadata.from_nebula_idl(pb2_object.metadata),
            pod_spec=_json_format.MessageToDict(pb2_object.pod_spec) if pb2_object.HasField("pod_spec") else None,
            data_config=DataLoadingConfig.from_nebula_idl(pb2_object.data_config)
            if pb2_object.HasField("data_config")
            else None,
        )


class Sql(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self) -> _core_task.Sql:
        return _core_task.Sql(statement=self.statement, dialect=self.dialect)

    @classmethod
    def from_nebula_idl(cls, pb2_object: _core_task.Sql):
        return cls(

...
from nebulakit.models.core import catalog as catalog_models
from nebulakit.models.core import compiler as core_compiler_models
...
class WorkflowNodeMetadata(_common_models.NebulaIdlEntity):
    ...
    def to_nebula_idl(self) -> _node_execution_pb2.WorkflowNodeMetadata:
        return _node_execution_pb2.WorkflowNodeMetadata(
            executionId=self.execution_id.to_nebula_idl(),
        )

    @classmethod
    def from_nebula_idl(cls, p: _node_execution_pb2.WorkflowNodeMetadata) -> "WorkflowNodeMetadata":
        return cls(
            execution_id=_identifier.WorkflowExecutionIdentifier.from_nebula_idl(p.executionId),
        )


class DynamicWorkflowNodeMetadata(_common_models.NebulaIdlEntity):
    ...
    def to_nebula_idl(self) -> _node_execution_pb2.DynamicWorkflowNodeMetadata:
        return _node_execution_pb2.DynamicWorkflowNodeMetadata(
            id=self.id.to_nebula_idl(),
            compiled_workflow=self.compiled_workflow.to_nebula_idl(),
        )

    @classmethod
    def from_nebula_idl(cls, p: _node_execution_pb2.DynamicWorkflowNodeMetadata) -> "DynamicWorkflowNodeMetadata":
        yy = cls(
            id=_identifier.Identifier.from_nebula_idl(p.id),
            compiled_workflow=core_compiler_models.CompiledWorkflowClosure.from_nebula_idl(p.compiled_workflow),
        )
        return yy


class TaskNodeMetadata(_common_models.NebulaIdlEntity):
    ...
    def to_nebula_idl(self) -> _node_execution_pb2.TaskNodeMetadata:
        return _node_execution_pb2.TaskNodeMetadata(
            cache_status=self.cache_status,
            catalog_key=self.catalog_key.to_nebula_idl(),
        )

    @classmethod
    def from_nebula_idl(cls, p: _node_execution_pb2.TaskNodeMetadata) -> "TaskNodeMetadata":
        return cls(
            cache_status=p.cache_status,
            catalog_key=catalog_models.CatalogMetadata.from_nebula_idl(p.catalog_key),
        )


class NodeExecutionClosure(_common_models.NebulaIdlEntity):
    def __init__(
        self,
        phase,
        started_at,
        ...
        :param nebulakit.models.core.execution.ExecutionError error:
        """
        self._phase = phase
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.admin.node_execution_pb2.NodeExecutionClosure
        """
        obj = _node_execution_pb2.NodeExecutionClosure(
            ...
            workflow_node_metadata=self.workflow_node_metadata.to_nebula_idl()
            if self.workflow_node_metadata is not None
            else None,
            task_node_metadata=self.task_node_metadata.to_nebula_idl() if self.task_node_metadata is not None else None,
        )
    ...
    def from_nebula_idl(cls, p):
        """
        :param nebulaidl.admin.node_execution_pb2.NodeExecutionClosure p:
        ...
        return cls(
            ...
            deck_uri=p.deck_uri,
            error=_core_execution.ExecutionError.from_nebula_idl(p.error) if p.HasField("error") else None,
            started_at=p.started_at.ToDatetime().replace(tzinfo=_timezone.utc),
            duration=p.duration.ToTimedelta(),
            workflow_node_metadata=WorkflowNodeMetadata.from_nebula_idl(p.workflow_node_metadata)
            if p.HasField("workflow_node_metadata")
            else None,
            task_node_metadata=TaskNodeMetadata.from_nebula_idl(p.task_node_metadata)
...
class NodeExecutionMetaData(_common_models.NebulaIdlEntity):
    ...
    def to_nebula_idl(self) -> _node_execution_pb2.NodeExecutionMetaData:
    ...
    @classmethod
    def from_nebula_idl(cls, p: _node_execution_pb2.NodeExecutionMetaData) -> "NodeExecutionMetaData":
        return cls(
...
class NodeExecution(_common_models.NebulaIdlEntity):
    def __init__(self, id, input_uri, closure, metadata):
        """
        :param nebulakit.models.core.identifier.NodeExecutionIdentifier id:
    ...
    def id(self):
        """
        :rtype: nebulakit.models.core.identifier.NodeExecutionIdentifier
        """
        return self._id
    ...
    def to_nebula_idl(self) -> _node_execution_pb2.NodeExecution:
    ...
    @classmethod
    def from_nebula_idl(cls, p: _node_execution_pb2.NodeExecution) -> "NodeExecution":
        return cls(
            id=_identifier.NodeExecutionIdentifier.from_nebula_idl(p.id),
            input_uri=p.input_uri,
            closure=NodeExecutionClosure.from_nebula_idl(p.closure),
            metadata=NodeExecutionMetaData.from_nebula_idl(p.metadata),
        )

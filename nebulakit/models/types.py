...
class SchemaType(_common.NebulaIdlEntity):
    class SchemaColumn(_common.NebulaIdlEntity):
        ...
        def to_nebula_idl(self):
            """
            :rtype: nebulaidl.core.types_pb2.SchemaType.SchemaColumn
            """
        ...
        def from_nebula_idl(cls, proto):
            """
            :param nebulaidl.core.types_pb2.SchemaType.SchemaColumn proto:
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.types_pb2.SchemaType
        """
        return _types_pb2.SchemaType(columns=[c.to_nebula_idl() for c in self.columns])

    @classmethod
    def from_nebula_idl(cls, proto):
        """
        :param nebulaidl.core.types_pb2.SchemaType proto:
        :rtype: SchemaType
        """
        return cls(columns=[SchemaType.SchemaColumn.from_nebula_idl(c) for c in proto.columns])


class UnionType(_common.NebulaIdlEntity):
    """
    ...
    def to_nebula_idl(self) -> _types_pb2.UnionType:
        return _types_pb2.UnionType(
            variants=[val.to_nebula_idl() if val else None for val in self._variants],
        )

    @classmethod
    def from_nebula_idl(cls, proto: _types_pb2.UnionType):
        return cls(variants=[LiteralType.from_nebula_idl(v) for v in proto.variants])


class TypeStructure(_common.NebulaIdlEntity):
    """
    ...
    def to_nebula_idl(self) -> _types_pb2.TypeStructure:
        return _types_pb2.TypeStructure(
            tag=self._tag,
            dataclass_type={k: v.to_nebula_idl() for k, v in self._dataclass_type.items()}
            if self._dataclass_type is not None
            else None,
        )

    @classmethod
    def from_nebula_idl(cls, proto: _types_pb2.TypeStructure):
        return cls(
            tag=proto.tag,
            dataclass_type={k: LiteralType.from_nebula_idl(v) for k, v in proto.dataclass_type.items()}
            if proto.dataclass_type is not None
            else None,
        )


class StructuredDatasetType(_common.NebulaIdlEntity):
    class DatasetColumn(_common.NebulaIdlEntity):
        ...
        def to_nebula_idl(self) -> _types_pb2.StructuredDatasetType.DatasetColumn:
            return _types_pb2.StructuredDatasetType.DatasetColumn(
                name=self.name, literal_type=self.literal_type.to_nebula_idl()
            )
        ...
        def from_nebula_idl(
            ...
            return cls(name=proto.name, literal_type=LiteralType.from_nebula_idl(proto.literal_type))
    ...
    def to_nebula_idl(self) -> _types_pb2.StructuredDatasetType:
        return _types_pb2.StructuredDatasetType(
            columns=[c.to_nebula_idl() for c in self.columns] if self.columns else None,
            format=self.format,
    ...
    @classmethod
    def from_nebula_idl(cls, proto: _types_pb2.StructuredDatasetType) -> _types_pb2.StructuredDatasetType:
        return cls(
            columns=[StructuredDatasetType.DatasetColumn.from_nebula_idl(c) for c in proto.columns],
            format=proto.format,
...
class LiteralType(_common.NebulaIdlEntity):
    def __init__(
        self,
        simple=None,
        schema=None,
        ...
        """
        This is a oneof message, only one of the kwargs may be set, representing one of the Nebula types.
        ...
        :param LiteralType map_value_type: For map objects, this is the type of the value.  The key must always be a
            string.
        :param nebulakit.models.core.types.BlobType blob: For blob objects, this describes the type.
        :param nebulakit.models.core.types.EnumType enum_type: For enum objects, describes an enum
        :param nebulakit.models.core.types.UnionType union_type: For union objects, describes an python union type.
        :param nebulakit.models.core.types.TypeStructure structure: Type matching hints
        :param nebulakit.models.core.types.StructuredDatasetType structured_dataset_type: structured dataset
        :param dict[Text, T] metadata: Additional data describing the type
        :param nebulakit.models.annotation.TypeAnnotation annotation: Additional data
    ...
    def annotation(self) -> TypeAnnotationModel:
        """
        :rtype: nebulakit.models.annotation.TypeAnnotation
        """
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.types_pb2.LiteralType
        """
        ...
        t = _types_pb2.LiteralType(
            ...
            collection_type=self.collection_type.to_nebula_idl() if self.collection_type is not None else None,
            map_value_type=self.map_value_type.to_nebula_idl() if self.map_value_type is not None else None,
            blob=self.blob.to_nebula_idl() if self.blob is not None else None,
            enum_type=self.enum_type.to_nebula_idl() if self.enum_type else None,
            union_type=self.union_type.to_nebula_idl() if self.union_type else None,
            structured_dataset_type=self.structured_dataset_type.to_nebula_idl()
            if self.structured_dataset_type
            else None,
            metadata=metadata,
            annotation=self.annotation.to_nebula_idl() if self.annotation else None,
            structure=self.structure.to_nebula_idl() if self.structure else None,
        )
        return t
    ...
    def from_nebula_idl(cls, proto):
        """
        :param nebulaidl.core.types_pb2.LiteralType proto:
        :rtype: LiteralType
        """
        collection_type = None
        map_value_type = None
        if proto.HasField("collection_type"):
            collection_type = LiteralType.from_nebula_idl(proto.collection_type)
        if proto.HasField("map_value_type"):
            map_value_type = LiteralType.from_nebula_idl(proto.map_value_type)
        return cls(
            simple=proto.simple if proto.HasField("simple") else None,
            schema=SchemaType.from_nebula_idl(proto.schema) if proto.HasField("schema") else None,
            collection_type=collection_type,
            map_value_type=map_value_type,
            blob=_core_types.BlobType.from_nebula_idl(proto.blob) if proto.HasField("blob") else None,
            enum_type=_core_types.EnumType.from_nebula_idl(proto.enum_type) if proto.HasField("enum_type") else None,
            union_type=UnionType.from_nebula_idl(proto.union_type) if proto.HasField("union_type") else None,
            structured_dataset_type=StructuredDatasetType.from_nebula_idl(proto.structured_dataset_type)
            if proto.HasField("structured_dataset_type")
            else None,
            metadata=_json_format.MessageToDict(proto.metadata) or None,
            structure=TypeStructure.from_nebula_idl(proto.structure) if proto.HasField("structure") else None,
            annotation=TypeAnnotationModel.from_nebula_idl(proto.annotation) if proto.HasField("annotation") else None,
        )


class OutputReference(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.types.OutputReference
        """
    ...
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.core.types.OutputReference pb2_object:
...
class Error(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self) -> _types_pb2.Error:
    ...
    @classmethod
    def from_nebula_idl(cls, pb2_object: _types_pb2.Error) -> "Error":
        """
        :param nebulaidl.core.types.OutputReference pb2_object:
        :rtype: OutputReference
        """

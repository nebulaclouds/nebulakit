...
import yaml
from nebulaidl.admin.execution_pb2 import WorkflowExecutionGetMetricsRequest
from nebulaidl.core.identifier_pb2 import WorkflowExecutionIdentifier

from nebulakit.clis.sdk_in_container.constants import CTX_DOMAIN, CTX_PROJECT
...
_explain_help = """
The explain command prints each individual execution span and the associated timestamps and Nebula entity reference.
This breakdown provides precise information into exactly how and when Nebula processes a workflow execution.
...
@click.option(
    ...
    type=int,
    default=-1,
    help="The depth of Nebula entity hierarchy to traverse when computing metrics for this execution",
)
@click.option(
    "-p",
    "--project",

# Nebulakit Kubeflow PyTorch Plugin
...
To set up PyTorch operator in the Nebula deployment's backend, follow the [PyTorch Operator Setup](https://docs.nebula.org/en/latest/deployment/plugin_setup/pytorch_operator.html) guide.

An [example](https://docs.nebula.org/projects/cookbook/en/latest/auto/integrations/kubernetes/kfpytorch/pytorch_mnist.html#sphx-glr-auto-integrations-kubernetes-kfpytorch-pytorch-mnist-py) showcasing PyTorch operator can be found in the documentation.
...
```python
from nebulakitplugins.kfpytorch import PyTorch, Worker, RestartPolicy, RunPolicy

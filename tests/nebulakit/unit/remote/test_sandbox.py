...
IMAGE_STR = "nebulacookbook:core-f7af27e23b3935a166645cf96a68583cdd263a87"
...
def test_fetch_one_wf():
    wf = rr.fetch_workflow(name="core.nebula_basics.files.rotate_one_workflow", version=RELEASED_EXAMPLES_VERSION)
...
def test_register_a_hello_world_wf():
    ...
    ss = SerializationSettings(image_config, project="nebulasnacks", domain="development", version=version)
...
def test_run_directly_hello_world_wf():
    ...
    rr.execute(hello_wf, inputs={"a": 5}, project="nebulasnacks", domain="development", version=version)

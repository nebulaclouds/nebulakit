...
Once you've had a handle on tasks, we can move to workflows. Workflow are the other basic building block of Nebula.
...
# and use them in subsequent tasks as normal. See :py:func:`nebulakit.workflow`
@workflow

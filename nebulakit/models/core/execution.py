...
class WorkflowExecutionPhase(object):
    """
    This class holds enum values used for setting notifications. See :py:class:`nebulakit.Email`
    for sample usage.
    """
...
class ExecutionError(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.execution_pb2.ExecutionError
        """
...
class TaskLog(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.execution_pb2.TaskLog
        """
    ...
    def from_nebula_idl(cls, p):
        """
        :param nebulaidl.core.execution_pb2.TaskLog p:
        :rtype: TaskLog
        """
        return cls(
            uri=p.uri,

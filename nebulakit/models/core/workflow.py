...
from nebulaidl.core import tasks_pb2
from nebulaidl.core import workflow_pb2 as _core_workflow
...
from nebulakit.models.core import condition as _condition
from nebulakit.models.core import identifier as _identifier
from nebulakit.models.literals import Binding as _Binding
from nebulakit.models.literals import RetryStrategy as _RetryStrategy
from nebulakit.models.task import Resources


class IfBlock(_common.NebulaIdlEntity):
    def __init__(self, condition, then_node):
        """
        Defines a condition and the execution unit that should be executed if the condition is satisfied.

        :param nebulakit.models.core.condition.BooleanExpression condition:
    ...
    def condition(self):
        """
        :rtype: nebulakit.models.core.condition.BooleanExpression
        """
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.workflow_pb2.IfBlock
        """
        return _core_workflow.IfBlock(condition=self.condition.to_nebula_idl(), then_node=self.then_node.to_nebula_idl())

    @classmethod
    def from_nebula_idl(cls, pb2_object):
        return cls(
            condition=_condition.BooleanExpression.from_nebula_idl(pb2_object.condition),
            then_node=Node.from_nebula_idl(pb2_object.then_node),
        )


class IfElseBlock(_common.NebulaIdlEntity):
    ...
    def error(self):
        ...
        :rtype: nebulakit.models.types.Error
        """
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.workflow_pb2.IfElseBlock
        """
        return _core_workflow.IfElseBlock(
            case=self.case.to_nebula_idl(),
            other=[a.to_nebula_idl() for a in self.other] if self.other else None,
            else_node=self.else_node.to_nebula_idl() if self.else_node else None,
            error=self.error.to_nebula_idl() if self.error else None,
        )

    @classmethod
    def from_nebula_idl(cls, pb2_object):
        return cls(
            case=IfBlock.from_nebula_idl(pb2_object.case),
            other=[IfBlock.from_nebula_idl(a) for a in pb2_object.other],
            else_node=Node.from_nebula_idl(pb2_object.else_node) if pb2_object.HasField("else_node") else None,
            error=type_models.Error.from_nebula_idl(pb2_object.error) if pb2_object.HasField("error") else None,
        )


class BranchNode(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.workflow_pb2.BranchNode
        """
        return _core_workflow.BranchNode(if_else=self.if_else.to_nebula_idl())

    @classmethod
    def from_nebula_idl(cls, pb2_objct):
        return cls(if_else=IfElseBlock.from_nebula_idl(pb2_objct.if_else))


class NodeMetadata(_common.NebulaIdlEntity):
    def __init__(self, name, timeout=None, retries=None, interruptible=None):
        ...
        :param nebulakit.models.literals.RetryStrategy retries: [Optional] Number of retries per task.
    ...
    def retries(self):
        """
        :rtype: nebulakit.models.literals.RetryStrategy
        """
    ...
    def interruptible(self):
        """
        :rtype: nebulakit.models
        """
        return self._interruptible

    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.workflow_pb2.NodeMetadata
        """
        node_metadata = _core_workflow.NodeMetadata(
            name=self.name,
            retries=self.retries.to_nebula_idl(),
    ...
    def from_nebula_idl(cls, pb2_object):
        return cls(
            ...
            _RetryStrategy.from_nebula_idl(pb2_object.retries),
        )


class SignalCondition(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self) -> _core_workflow.SignalCondition:
        return _core_workflow.SignalCondition(
            signal_id=self.signal_id, type=self.type.to_nebula_idl(), output_variable_name=self.output_variable_name
        )

    @classmethod
    def from_nebula_idl(cls, pb2_object: _core_workflow.SignalCondition):
        return cls(
            signal_id=pb2_object.signal_id,
            type=type_models.LiteralType.from_nebula_idl(pb2_object.type),
            output_variable_name=pb2_object.output_variable_name,
        )


class ApproveCondition(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self) -> _core_workflow.ApproveCondition:
        return _core_workflow.ApproveCondition(signal_id=self.signal_id)

    @classmethod
    def from_nebula_idl(cls, pb2_object: _core_workflow.ApproveCondition):
        return cls(signal_id=pb2_object.signal_id)


class SleepCondition(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self) -> _core_workflow.SleepCondition:
        sc = _core_workflow.SleepCondition()
        sc.duration.FromTimedelta(self.duration)
        return sc

    @classmethod
    def from_nebula_idl(cls, pb2_object: _core_workflow.SignalCondition) -> "SleepCondition":
        return cls(duration=pb2_object.duration.ToTimedelta())


class GateNode(_common.NebulaIdlEntity):
    def __init__(
        self,
    ...
    def to_nebula_idl(self) -> _core_workflow.GateNode:
        return _core_workflow.GateNode(
            signal=self.signal.to_nebula_idl() if self.signal else None,
            sleep=self.sleep.to_nebula_idl() if self.sleep else None,
            approve=self.approve.to_nebula_idl() if self.approve else None,
        )

    @classmethod
    def from_nebula_idl(cls, pb2_object: _core_workflow.GateNode) -> "GateNode":
        return cls(
            signal=SignalCondition.from_nebula_idl(pb2_object.signal) if pb2_object.HasField("signal") else None,
            sleep=SleepCondition.from_nebula_idl(pb2_object.sleep) if pb2_object.HasField("sleep") else None,
            approve=ApproveCondition.from_nebula_idl(pb2_object.approve) if pb2_object.HasField("approve") else None,
        )


class ArrayNode(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self) -> _core_workflow.ArrayNode:
        return _core_workflow.ArrayNode(
            node=self._node.to_nebula_idl() if self._node is not None else None,
    ...
    @classmethod
    def from_nebula_idl(cls, pb2_object) -> "ArrayNode":
        return cls(
            Node.from_nebula_idl(pb2_object.node),
...
class Node(_common.NebulaIdlEntity):
    def __init__(
        self,
        id,
        metadata,
        ...
        :param list[nebulakit.models.literals.Binding] inputs: Specifies how to bind the underlying
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.workflow_pb2.Node
        """
        return _core_workflow.Node(
            id=self.id,
            metadata=self.metadata.to_nebula_idl() if self.metadata is not None else None,
            inputs=[i.to_nebula_idl() for i in self.inputs],
            upstream_node_ids=self.upstream_node_ids,
            output_aliases=[a.to_nebula_idl() for a in self.output_aliases],
            task_node=self.task_node.to_nebula_idl() if self.task_node is not None else None,
            workflow_node=self.workflow_node.to_nebula_idl() if self.workflow_node is not None else None,
            branch_node=self.branch_node.to_nebula_idl() if self.branch_node is not None else None,
            gate_node=self.gate_node.to_nebula_idl() if self.gate_node else None,
            array_node=self.array_node.to_nebula_idl() if self.array_node else None,
        )

    @classmethod
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.core.workflow_pb2.Node pb2_object:
        :rtype: Node
        """
        return cls(
            id=pb2_object.id,
            metadata=NodeMetadata.from_nebula_idl(pb2_object.metadata),
            inputs=[_Binding.from_nebula_idl(b) for b in pb2_object.inputs],
            upstream_node_ids=pb2_object.upstream_node_ids,
            output_aliases=[Alias.from_nebula_idl(a) for a in pb2_object.output_aliases],
            task_node=TaskNode.from_nebula_idl(pb2_object.task_node) if pb2_object.HasField("task_node") else None,
            workflow_node=WorkflowNode.from_nebula_idl(pb2_object.workflow_node)
            if pb2_object.HasField("workflow_node")
            else None,
            branch_node=BranchNode.from_nebula_idl(pb2_object.branch_node)
            if pb2_object.HasField("branch_node")
            else None,
            gate_node=GateNode.from_nebula_idl(pb2_object.gate_node) if pb2_object.HasField("gate_node") else None,
            array_node=ArrayNode.from_nebula_idl(pb2_object.array_node) if pb2_object.HasField("array_node") else None,
        )


class TaskNodeOverrides(_common.NebulaIdlEntity):
    def __init__(
    ...
    def to_nebula_idl(self):
        return _core_workflow.TaskNodeOverrides(
            resources=self.resources.to_nebula_idl() if self.resources is not None else None,
            extended_resources=self.extended_resources,
        )

    @classmethod
    def from_nebula_idl(cls, pb2_object):
        resources = Resources.from_nebula_idl(pb2_object.resources)
...
class TaskNode(_common.NebulaIdlEntity):
    def __init__(self, reference_id, overrides: typing.Optional[TaskNodeOverrides] = None):
        ...
        :param nebulakit.models.core.identifier.Identifier reference_id: A globally unique identifier for the task.
        :param nebulaidl.core.workflow_pb2.TaskNodeOverrides:
        """
    ...
    def reference_id(self):
        """
        A globally unique identifier for the task. This should map to the identifier in Nebula Admin.
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.workflow_pb2.TaskNode
        """
        return _core_workflow.TaskNode(
            reference_id=self.reference_id.to_nebula_idl(),
            overrides=self.overrides.to_nebula_idl() if self.overrides is not None else None,
        )

    @classmethod
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.core.workflow_pb2.TaskNode pb2_object:
        :rtype: TaskNode
        """
        overrides = TaskNodeOverrides.from_nebula_idl(pb2_object.overrides)
        if overrides.resources is None:
            overrides = None
        return cls(
            reference_id=_identifier.Identifier.from_nebula_idl(pb2_object.reference_id),
            overrides=overrides,
        )


class WorkflowNode(_common.NebulaIdlEntity):
    def __init__(self, launchplan_ref=None, sub_workflow_ref=None):
        ...
        :param nebulakit.models.core.identifier.Identifier launchplan_ref: [Optional] A globally unique identifier for
            the launch plan. Should map to Admin.
        :param nebulakit.models.core.identifier.Identifier sub_workflow_ref: [Optional] Reference to a subworkflow,
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.workflow_pb2.WorkflowNode
        """
        return _core_workflow.WorkflowNode(
            launchplan_ref=self.launchplan_ref.to_nebula_idl() if self.launchplan_ref else None,
            sub_workflow_ref=self.sub_workflow_ref.to_nebula_idl() if self.sub_workflow_ref else None,
        )

    @classmethod
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.core.workflow_pb2.WorkflowNode pb2_object:

        :rtype: WorkflowNode
        """
        if pb2_object.HasField("launchplan_ref"):
            return cls(launchplan_ref=_identifier.Identifier.from_nebula_idl(pb2_object.launchplan_ref))
        else:
            return cls(sub_workflow_ref=_identifier.Identifier.from_nebula_idl(pb2_object.sub_workflow_ref))


class WorkflowMetadata(_common.NebulaIdlEntity):
    ...
    def __init__(self, on_failure=None):
        ...
        :param on_failure nebulakit.models.core.workflow.WorkflowMetadata.OnFailurePolicy: [Optional] The execution policy when the workflow detects a failure.
        """
    ...
    def on_failure(self):
        """
        :rtype: nebulakit.models.core.workflow.WorkflowMetadata.OnFailurePolicy
        """
        return self._on_failure

    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.workflow_pb2.WorkflowMetadata
        """
    ...
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.core.workflow_pb2.WorkflowMetadata pb2_object:
...
class WorkflowMetadataDefaults(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.workflow_pb2.WorkflowMetadataDefaults
        """
    ...
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.core.workflow_pb2.WorkflowMetadataDefaults pb2_object:
...
class WorkflowTemplate(_common.NebulaIdlEntity):
    def __init__(
        self,
        id,
        metadata,
        ...
        :param nebulakit.models.core.identifier.Identifier id: This is an autogenerated id by the system. The id is
            globally unique across Nebula.
        ...
        :param nebulakit.models.interface.TypedInterface interface: Defines a strongly typed interface for the
        ...
        :param list[nebulakit.models.literals.Binding] outputs: A list of output bindings that specify how to construct
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.workflow_pb2.WorkflowTemplate
        """
        return _core_workflow.WorkflowTemplate(
            id=self.id.to_nebula_idl(),
            metadata=self.metadata.to_nebula_idl(),
            metadata_defaults=self.metadata_defaults.to_nebula_idl(),
            interface=self.interface.to_nebula_idl(),
            nodes=[n.to_nebula_idl() for n in self.nodes],
            outputs=[o.to_nebula_idl() for o in self.outputs],
            failure_node=self.failure_node.to_nebula_idl() if self.failure_node is not None else None,
        )

    @classmethod
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.core.workflow_pb2.WorkflowTemplate pb2_object:

        :rtype: WorkflowTemplate
        """
        return cls(
            id=_identifier.Identifier.from_nebula_idl(pb2_object.id),
            metadata=WorkflowMetadata.from_nebula_idl(pb2_object.metadata),
            metadata_defaults=WorkflowMetadataDefaults.from_nebula_idl(pb2_object.metadata_defaults),
            interface=_interface.TypedInterface.from_nebula_idl(pb2_object.interface),
            nodes=[Node.from_nebula_idl(n) for n in pb2_object.nodes],
            outputs=[_Binding.from_nebula_idl(b) for b in pb2_object.outputs],
            failure_node=Node.from_nebula_idl(pb2_object.failure_node) if pb2_object.HasField("failure_node") else None,
        )


class Alias(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.workflow_pb2.Alias
        """
    ...
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.core.workflow_pb2.Alias pb2_object:

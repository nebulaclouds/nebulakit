...
from nebulakit.interaction.click_types import (
    DateTimeType,
    DurationParamType,
    FileParamType,
    NebulaLiteralConverter,
    JsonParamType,
    key_value_callback,
)
...
def test_enum_converter(python_type: typing.Type, python_str_value: str, python_value: typing.Any):
    ...
    lc = NebulaLiteralConverter(ctx, literal_type=lt, python_type=pt, is_remote=True)

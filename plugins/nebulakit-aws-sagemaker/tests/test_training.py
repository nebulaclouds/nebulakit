...
import pytest
from nebulakitplugins.awssagemaker.distributed_training import setup_envars_for_testing
...
def test_distributed_custom_training():
    ...
    def my_custom_trainer(x: int) -> int:
        assert nebulakit.current_context().distributed_training_context is not None
        return x

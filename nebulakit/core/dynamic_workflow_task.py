...
Dynamic Workflows
-----------------------------
Dynamic workflows are one of the powerful aspects of Nebula. Please take a look at the :py:func:`nebulakit.dynamic` documentation first to get started.
...
from nebulakit.core import task
...
dynamic.__doc__ = """
Please first see the comments for :py:func:`nebulakit.task` and :py:func:`nebulakit.workflow`. This ``dynamic``
...
The resulting workflow is passed back to the Nebula engine and is

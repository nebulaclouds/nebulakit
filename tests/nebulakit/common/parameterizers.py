...
from nebulakit.models import interface, literals, security, task, types
...
LIST_OF_RUNTIME_METADATA = [
    ...
    task.RuntimeMetadata(task.RuntimeMetadata.RuntimeType.NEBULA_SDK, "1.0.0b0", "golang"),
]
...
LIST_OF_EXTENDED_RESOURCES = [
    None,
    *[
        tasks_pb2.ExtendedResources(gpu_accelerator=None if accelerator is None else accelerator.to_nebula_idl())

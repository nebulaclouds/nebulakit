...
class PILImageTransformer(TypeTransformer[T]):
    ...
    def to_literal(
        self, ctx: NebulaContext, python_val: PIL.Image.Image, python_type: Type[T], expected: LiteralType
    ) -> Literal:
        meta = BlobMetadata(
    ...
    def to_python_value(self, ctx: NebulaContext, lv: Literal, expected_python_type: Type[T]) -> PIL.Image.Image:
        try:
    ...
    def to_html(self, ctx: NebulaContext, python_val: PIL.Image.Image, expected_python_type: Type[T]) -> str:
        import base64

...
class Identifier(_core_identifier.Identifier):
    ...
    def promote_from_model(cls, base_model):
        """
        :param nebulakit.models.core.identifier.Identifier base_model:
        :rtype: Identifier
        """
        return cls(
    ...
    def from_nebula_idl(cls, pb2_object):
        base_model = super().from_nebula_idl(pb2_object)
...
class TaskExecutionIdentifier(_core_identifier.TaskExecutionIdentifier):
    ...
    def promote_from_model(cls, base_model):
        """
        :param nebulakit.models.core.identifier.TaskExecutionIdentifier base_model:
...
class WorkflowExecutionIdentifier(_core_identifier.WorkflowExecutionIdentifier):
    ...
    def promote_from_model(cls, base_model):
        """
        :param nebulakit.models.core.identifier.WorkflowExecutionIdentifier base_model:

...
from nebulaidl.plugins import spark_pb2 as _spark_task
...
class SparkJob(_common.NebulaIdlEntity):
    def __init__(
        self,
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.plugins.spark_pb2.SparkJob
        """
        ...
        if self.spark_type == SparkType.PYTHON:
            ...
            raise _user_exceptions.NebulaValidationException("Invalid Spark Application Type Specified")
    ...
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.plugins.spark_pb2.SparkJob pb2_object:
        :rtype: SparkJob
        """

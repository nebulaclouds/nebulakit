...
from nebulakit import ContainerTask, Resources
...
from nebulakit.core.reference_entity import ReferenceSpec, ReferenceTemplate
from nebulakit.core.task import ReferenceTask, task
from nebulakit.core.workflow import ReferenceWorkflow, workflow
from nebulakit.models.core import identifier as identifier_models
from nebulakit.models.task import Resources as resource_model
...
def test_basics():
    ...
    assert "pynebula-execute" in task_spec.template.container.args
...
def test_fast():
    ...
    task_spec = get_serializable(OrderedDict(), ssettings, t1)
    assert "pynebula-fast-execute" in task_spec.template.container.args
...
def test_container():
    ...
    assert "pynebula" not in task_spec.template.container.args

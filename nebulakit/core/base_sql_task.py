...
class SQLTask(PythonTask[T]):
    """
    Base task types for all SQL tasks. See :py:class:`nebulakit.extras.sqlite3.task.SQLite3Task`
    and :py:class:`nebulakitplugins.athena.task.AthenaTask` for examples of how to use it as a base class.

    .. autoclass:: nebulakit.extras.sqlite3.task.SQLite3Task
       :noindex:
    """
    ...
    def __init__(
        ...
        **kwargs,
        ...
        directly. See :py:class:`nebulakit.extras.sqlite3.task.SQLite3Task`
        """
        super().__init__(
            task_type=task_type,
            name=name,
    ...
    def interpolate_query(cls, query_template, **kwargs) -> Any:
        ...
        Please note that when SQL tasks run in Nebula, this step is done by the task executor.
        """

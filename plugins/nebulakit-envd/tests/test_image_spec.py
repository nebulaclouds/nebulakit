...
from nebulakitplugins.envd.image_builder import EnvdImageSpecBuilder, create_envd_config
...
def build():
    base(image="cr.nebula.org/nebulaclouds/nebulakit:py3.8-latest", dev=False)

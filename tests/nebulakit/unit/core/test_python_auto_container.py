...
from nebulakit.core.base_task import TaskMetadata
from nebulakit.core.pod_template import PodTemplate
from nebulakit.core.python_auto_container import PythonAutoContainerTask, get_registerable_container_image
...
def test_default_command(default_serialization_settings):
    ...
    assert cmd == [
        ...
        "--",
        "task-module",
        "tests.nebulakit.unit.core.test_python_auto_container",
        "task-name",
        "task",
    ]

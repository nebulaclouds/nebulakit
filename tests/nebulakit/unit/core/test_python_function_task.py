...
from nebulakit.core.tracker import isnested, istestfunction
...
from tests.nebulakit.unit.core import tasks
...
def test_pod_template():
    ...
    assert primary_container["args"] == [
        ...
        "--",
        "task-module",
        "tests.nebulakit.unit.core.test_python_function_task",
        "task-name",

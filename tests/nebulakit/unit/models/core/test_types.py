...
from nebulakit.models.core import types as _types
...
def test_blob_type():
    ...
    o2 = _types.BlobType.from_nebula_idl(o.to_nebula_idl())
    assert o == o2
...
def test_enum_type():
    ...
    o = _types.EnumType.from_nebula_idl(_types_pb2.EnumType(values=["a", "b"]))
    assert o.values == ["a", "b"]

...
import click
from nebulaidl.admin.launch_plan_pb2 import LaunchPlan
from nebulaidl.admin.task_pb2 import TaskSpec
from nebulaidl.admin.workflow_pb2 import WorkflowSpec
from nebulaidl.core import identifier_pb2 as _identifier_pb2
from nebulaidl.core import workflow_pb2 as _workflow_pb2

from nebulakit.configuration import DOMAIN_PLACEHOLDER, PROJECT_PLACEHOLDER, VERSION_PLACEHOLDER
...
# TODO Deprecated delete after deleting nebula_cli register
...
def hydrate_registration_parameters(
    ...
    # in now.
    # (entity is of type nebulaidl.admin.workflow_pb2.WorkflowSpec)

...
from nebulakit.core.base_task import PythonTask, TaskMetadata
...
from nebulakit.core.utils import _get_container_definition, _serialize_pod_spec
...
class ContainerTask(PythonTask):
    """
    This is an intermediate class that represents Nebula Tasks that run a container at execution time. This is the vast
    ...
    def local_execute(self, ctx: NebulaContext, **kwargs) -> Any:

...
def test_notification_email():
    ...
    obj2 = _common.EmailNotification.from_nebula_idl(obj.to_nebula_idl())
    assert obj2 == obj
...
def test_notification_pagerduty():
    ...
    assert obj.recipients_email == ["a", "b", "c"]
    obj2 = _common.PagerDutyNotification.from_nebula_idl(obj.to_nebula_idl())
    assert obj2 == obj
...
def test_notification_slack():
    ...
    assert obj.recipients_email == ["a", "b", "c"]
    obj2 = _common.SlackNotification.from_nebula_idl(obj.to_nebula_idl())
    assert obj2 == obj
...
def test_notification():
    ...
    obj2 = _common.Notification.from_nebula_idl(obj.to_nebula_idl())
    assert obj == obj2
...
def test_labels():
    ...
    obj2 = _common.Labels.from_nebula_idl(obj.to_nebula_idl())
    assert obj2 == obj
...
def test_annotations():
    ...
    obj2 = _common.Annotations.from_nebula_idl(obj.to_nebula_idl())
    assert obj2 == obj
...
def test_auth_role():
    ...
    obj2 = _common.AuthRole.from_nebula_idl(obj.to_nebula_idl())
    assert obj == obj2
...
def test_raw_output_data_config():
    ...
    obj2 = _common.RawOutputDataConfig.from_nebula_idl(obj.to_nebula_idl())
    assert obj2 == obj
...
def test_auth_role_empty():
    ...
    x = obj.to_nebula_idl()
    y = _common.AuthRole.from_nebula_idl(x)
    assert y == obj

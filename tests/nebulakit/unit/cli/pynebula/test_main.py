...
from nebulakit.clis.nebula_cli.main import _get_client
from nebulakit.configuration import AuthType, PlatformConfig


@mock.patch("nebulakit.clients.friendly.SynchronousNebulaClient")
@mock.patch("click.get_current_context")
def test_get_client(click_current_ctx, mock_nebula_client):
    ...
    mock_nebula_client.assert_called_with(expected_platform_config)

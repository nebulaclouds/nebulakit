...
from nebulakit import Resources, map_task
...
from nebulakit.models.task import Resources as _resources_models
...
def test_config_override():
    ...
    @workflow
    def my_wf(a: str) -> str:
        return t1(a=a).with_overrides(task_config=DummyConfig("nebula"))

    assert my_wf.nodes[0].nebula_entity.task_config.name == "nebula"
...
def test_override_image():
    ...
    assert wf.nodes[0].nebula_entity.container_image == "hello/world"

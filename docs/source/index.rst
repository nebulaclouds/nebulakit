...
*************************
Nebulakit Python Reference
*************************

`Nebulakit Tags <_tags/tagsindex.html>`__

This section of the documentation provides detailed descriptions of the high-level design of ``Nebulakit`` and an
API reference for specific usage details of Python functions, classes, and decorators that you import to specify tasks,
build workflows, and extend ``Nebulakit``.
...
.. toctree::
   ...
   |book-reader| User Guide <https://docs.nebula.org/projects/cookbook/en/latest/index.html>
...
.. toctree::
   :maxdepth: -1
   :caption: Nebulakit SDK
   :hidden:

   Nebulakit Python <self>
   design/index
   nebulakit
   configuration
   remote

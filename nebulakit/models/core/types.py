...
class EnumType(_common.NebulaIdlEntity):
    """
    ...
    def to_nebula_idl(self) -> _types_pb2.EnumType:
        return _types_pb2.EnumType(
            values=self._values if self._values else [],
        )

    @classmethod
    def from_nebula_idl(cls, proto: _types_pb2.EnumType):
        return cls(values=proto.values)


class BlobType(_common.NebulaIdlEntity):
    """
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.types_pb2.BlobType
        """
    ...
    def from_nebula_idl(cls, proto):
        """
        :param nebulaidl.core.types_pb2.BlobType proto:
        :rtype: BlobType
        """

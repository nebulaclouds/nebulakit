...
from nebulakit.models.core import catalog, identifier
from tests.nebulakit.unit.common_tests.test_workflow_promote import get_compiled_workflow_closure


def test_metadata():
    md = node_execution_models.NodeExecutionMetaData(retry_group="0", is_parent_node=True, spec_node_id="n0")
    md2 = node_execution_models.NodeExecutionMetaData.from_nebula_idl(md.to_nebula_idl())
    assert md == md2
...
def test_workflow_node_metadata():
    ...
    obj2 = node_execution_models.WorkflowNodeMetadata.from_nebula_idl(obj.to_nebula_idl())
    assert obj == obj2
...
def test_task_node_metadata():
    ...
    obj2 = node_execution_models.TaskNodeMetadata.from_nebula_idl(obj.to_nebula_idl())
    assert obj2 == obj
...
def test_dynamic_wf_node_metadata():
    ...
    obj2 = node_execution_models.DynamicWorkflowNodeMetadata.from_nebula_idl(obj.to_nebula_idl())
    assert obj2 == obj

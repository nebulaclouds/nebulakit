...
from nebulakit.core.workflow import ImperativeWorkflow, get_promise, workflow
...
def test_imperative():
    ...
    from nebulakit.core.workflow import ImperativeWorkflow as Workflow  # noqa
...
def test_nonfunction_task_and_df_input():
    ...
    wb.add_workflow_input("sqlite_archive", NebulaFile[typing.TypeVar("sqlite")])

...
from nebulaidl.plugins.sagemaker import parameter_ranges_pb2 as _idl_parameter_ranges

from nebulakit.exceptions import user
...
class ContinuousParameterRange(_common.NebulaIdlEntity):
    def __init__(
        self,
        max_value: float,
        min_value: float,
    ...
    def to_nebula_idl(self) -> _idl_parameter_ranges.ContinuousParameterRange:
        """
    ...
    @classmethod
    def from_nebula_idl(cls, pb2_object: _idl_parameter_ranges.ContinuousParameterRange):
        """
...
class IntegerParameterRange(_common.NebulaIdlEntity):
    def __init__(
        self,
        max_value: int,
        min_value: int,
    ...
    def to_nebula_idl(self) -> _idl_parameter_ranges.IntegerParameterRange:
        """
    ...
    @classmethod
    def from_nebula_idl(cls, pb2_object: _idl_parameter_ranges.IntegerParameterRange):
        """
...
class CategoricalParameterRange(_common.NebulaIdlEntity):
    def __init__(
        self,
        values: List[str],
    ):
    ...
    def to_nebula_idl(self) -> _idl_parameter_ranges.CategoricalParameterRange:
        """
    ...
    @classmethod
    def from_nebula_idl(cls, pb2_object: _idl_parameter_ranges.CategoricalParameterRange):
        """
...
class ParameterRanges(_common.NebulaIdlEntity):
    def __init__(
        self,
        parameter_range_map: Dict[str, _common.NebulaIdlEntity],
    ):
        self._parameter_range_map = parameter_range_map

    def to_nebula_idl(self) -> _idl_parameter_ranges.ParameterRanges:
        """
        ...
        for k, v in self._parameter_range_map.items():
            if isinstance(v, IntegerParameterRange):
                converted[k] = _idl_parameter_ranges.ParameterRangeOneOf(integer_parameter_range=v.to_nebula_idl())
            elif isinstance(v, ContinuousParameterRange):
                converted[k] = _idl_parameter_ranges.ParameterRangeOneOf(continuous_parameter_range=v.to_nebula_idl())
            elif isinstance(v, CategoricalParameterRange):
                converted[k] = _idl_parameter_ranges.ParameterRangeOneOf(categorical_parameter_range=v.to_nebula_idl())
            else:
    ...
    @classmethod
    def from_nebula_idl(cls, pb2_object: _idl_parameter_ranges.ParameterRanges):
        """
        ...
        for k, v in pb2_object.parameter_range_map.items():
            if v.HasField("continuous_parameter_range"):
                converted[k] = ContinuousParameterRange.from_nebula_idl(v.continuous_parameter_range)
            elif v.HasField("integer_parameter_range"):
                converted[k] = IntegerParameterRange.from_nebula_idl(v.integer_parameter_range)
            else:
                converted[k] = CategoricalParameterRange.from_nebula_idl(v.categorical_parameter_range)
...
class ParameterRangeOneOf(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self) -> _idl_parameter_ranges.ParameterRangeOneOf:
        return _idl_parameter_ranges.ParameterRangeOneOf(
            integer_parameter_range=self.integer_parameter_range.to_nebula_idl()
            if self.integer_parameter_range
            else None,
            continuous_parameter_range=self.continuous_parameter_range.to_nebula_idl()
            if self.continuous_parameter_range
            else None,
            categorical_parameter_range=self.categorical_parameter_range.to_nebula_idl()
    ...
    def from_nebula_idl(
        ...
        if isinstance(pb_object, _idl_parameter_ranges.ParameterRangeOneOf):
            if pb_object.HasField("continuous_parameter_range"):
                param = ContinuousParameterRange.from_nebula_idl(pb_object.continuous_parameter_range)
            elif pb_object.HasField("integer_parameter_range"):
                param = IntegerParameterRange.from_nebula_idl(pb_object.integer_parameter_range)
            elif pb_object.HasField("categorical_parameter_range"):
                param = CategoricalParameterRange.from_nebula_idl(pb_object.categorical_parameter_range)
        elif isinstance(pb_object, _idl_parameter_ranges.IntegerParameterRange):
            param = IntegerParameterRange.from_nebula_idl(pb_object)
        elif isinstance(pb_object, _idl_parameter_ranges.ContinuousParameterRange):
            param = ContinuousParameterRange.from_nebula_idl(pb_object)
        elif isinstance(pb_object, _idl_parameter_ranges.CategoricalParameterRange):
            param = CategoricalParameterRange.from_nebula_idl(pb_object)

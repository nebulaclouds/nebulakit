from nebulakit.models.common import NebulaIdlEntity as _NebulaIdlEntity


class FilterList(_NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        ...
        :rtype: Text
        """
        return "+".join([f.to_nebula_idl() for f in self._filter_list])

    @classmethod
    def from_nebula_idl(cls):
        raise NotImplementedError("Filters are never recovered from a protobuf.")


class Filter(_NebulaIdlEntity):
    _comparator = "nil"

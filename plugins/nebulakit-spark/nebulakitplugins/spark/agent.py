...
import aiohttp
import grpc
from nebulaidl.admin.agent_pb2 import PENDING, CreateTaskResponse, DeleteTaskResponse, GetTaskResponse, Resource

from nebulakit.extend.backend.base_agent import AgentBase, AgentRegistry, convert_to_nebula_state, get_agent_secret
...
class DatabricksAgent(AgentBase):
    ...
    async def async_create(
        ...
        databricks_job["spark_python_task"] = {
            "python_file": "nebulakitplugins/spark/entrypoint.py",
            "source": "GIT",
            "parameters": container.args,
        }
        databricks_job["git_source"] = {
            "git_url": "https://github.com/nebulaclouds/nebulatools",
            "git_provider": "gitHub",
            # https://github.com/nebulaclouds/nebulatools/commit/aff8a9f2adbf5deda81d36d59a0b8fa3b1fc3679
    ...
    async def async_get(self, context: grpc.ServicerContext, resource_meta: bytes) -> GetTaskResponse:
        ...
        if state:
            if state.get("result_state"):
                cur_state = convert_to_nebula_state(state["result_state"])
...
def get_header() -> typing.Dict[str, str]:
    token = get_agent_secret("NEBULA_DATABRICKS_ACCESS_TOKEN")

...
from nebulakit.core.reference_entity import ReferenceEntity
...
def task_mock(t: PythonTask) -> typing.Generator[MagicMock, None, None]:
    """
    Use this method to mock a task declaration. It can mock any Task in Nebulakit as long as it has a python native
...
def patch(target: Union[PythonTask, WorkflowBase, ReferenceEntity]):
    ...
    logger.info(
        "When using this patch function on Nebula entities, please be aware weird issues may arise if also"
        "using mock.patch on internal Nebula classes like PythonFunctionWorkflow. See"
        "https://github.com/nebulaclouds/nebula/issues/854 for more information"
    )

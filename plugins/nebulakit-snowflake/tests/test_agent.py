...
import grpc
import pytest
from nebulaidl.admin.agent_pb2 import SUCCEEDED, DeleteTaskResponse
from nebulakitplugins.snowflake.agent import Metadata
...
from nebulakit.models.task import Sql, TaskTemplate


@mock.patch("nebulakitplugins.snowflake.agent.SnowflakeAgent.get_private_key", return_value="pb")

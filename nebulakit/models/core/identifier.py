from nebulaidl.core import identifier_pb2 as identifier_pb2
...
class Identifier(_common_models.NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.identifier_pb2.Identifier
        """
    ...
    def from_nebula_idl(cls, p):
        """
        :param nebulaidl.core.identifier_pb2.Identifier p:
        :rtype: Identifier
        """
        return cls(
...
class WorkflowExecutionIdentifier(_common_models.NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.identifier_pb2.WorkflowExecutionIdentifier
        """
    ...
    def from_nebula_idl(cls, p):
        """
        :param nebulaidl.core.identifier_pb2.WorkflowExecutionIdentifier p:
...
class NodeExecutionIdentifier(_common_models.NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.identifier_pb2.NodeExecutionIdentifier
        """
        return identifier_pb2.NodeExecutionIdentifier(
            node_id=self.node_id,
            execution_id=self.execution_id.to_nebula_idl(),
        )

    @classmethod
    def from_nebula_idl(cls, p):
        """
        :param nebulaidl.core.identifier_pb2.NodeExecutionIdentifier p:
        :rtype: NodeExecutionIdentifier
        """
        return cls(
            node_id=p.node_id,
            execution_id=WorkflowExecutionIdentifier.from_nebula_idl(p.execution_id),
        )


class TaskExecutionIdentifier(_common_models.NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.identifier_pb2.TaskExecutionIdentifier
        """
        return identifier_pb2.TaskExecutionIdentifier(
            task_id=self.task_id.to_nebula_idl(),
            node_execution_id=self.node_execution_id.to_nebula_idl(),
    ...
    def from_nebula_idl(cls, proto):
        """
        :param nebulaidl.core.identifier_pb2.TaskExecutionIdentifier proto:
        :rtype: TaskExecutionIdentifier
        """
        return cls(
            task_id=Identifier.from_nebula_idl(proto.task_id),
            node_execution_id=NodeExecutionIdentifier.from_nebula_idl(proto.node_execution_id),
            retry_attempt=proto.retry_attempt,
        )


class SignalIdentifier(_common_models.NebulaIdlEntity):
    ...
    def to_nebula_idl(self) -> identifier_pb2.SignalIdentifier:
    ...
    @classmethod
    def from_nebula_idl(cls, proto: identifier_pb2.SignalIdentifier) -> "SignalIdentifier":
        return cls(
            signal_id=proto.signal_id,
            execution_id=WorkflowExecutionIdentifier.from_nebula_idl(proto.execution_id),
        )

...
import nebulakit
from nebulakit import NebulaContextManager, task
from nebulakit.core.utils import _dnsify, timeit, ClassDecorator
...
def test_timeit():
    ...
    # check if timeit works for nebulakit level code
    ...
    time_info_list = nebulakit.current_context().timeline_deck.time_info
    names = [time_info["Name"] for time_info in time_info_list]

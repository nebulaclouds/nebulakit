...
from nebulakitplugins.flyin import (
...
from nebulakit.tools.translator import get_serializable_task
from nebulakit.configuration import Image, ImageConfig, SerializationSettings
from nebulakitplugins.flyin.vscode_lib.decorator import get_code_server_info
...
def vscode_patches():
    with mock.patch("multiprocessing.Process") as mock_process, mock.patch(
        "nebulakitplugins.flyin.vscode_lib.decorator.prepare_interactive_python"
    ) as mock_prepare_interactive_python, mock.patch(
        "nebulakitplugins.flyin.vscode_lib.decorator.exit_handler"
    ) as mock_exit_handler, mock.patch(
        "nebulakitplugins.flyin.vscode_lib.decorator.download_vscode"
    ) as mock_download_vscode, mock.patch("signal.signal") as mock_signal, mock.patch(
        "nebulakitplugins.flyin.vscode_lib.decorator.prepare_resume_task_python"
    ) as mock_prepare_resume_task_python, mock.patch(
        "nebulakitplugins.flyin.vscode_lib.decorator.prepare_launch_json"
...
@mock.patch("nebulakitplugins.flyin.jupyter_lib.decorator.subprocess.Popen")
@mock.patch("nebulakitplugins.flyin.jupyter_lib.decorator.sys.exit")

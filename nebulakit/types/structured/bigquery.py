...
def _read_from_bq(
    nebula_value: literals.StructuredDataset, current_task_metadata: StructuredDatasetMetadata
) -> pd.DataFrame:
...
class BQToPandasDecodingHandler(StructuredDatasetDecoder):
    ...
    def decode(
        ...
        return _read_from_bq(nebula_value, current_task_metadata)
...
class BQToArrowDecodingHandler(StructuredDatasetDecoder):
    ...
    def decode(
        ...
        return pa.Table.from_pandas(_read_from_bq(nebula_value, current_task_metadata))

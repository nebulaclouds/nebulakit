...
BaseModelLiterals = Annotated[
    ...
    BaseModel serialized to a LiteralMap consisting of:
        1) the basemodel json with placeholders for nebula types
        2) mapping from placeholders to serialized nebula type values in the object store
    """,
]
...
class BaseModelTransformer(type_engine.TypeTransformer[pydantic.BaseModel]):
    ...
    def to_python_value(
        ...
        """Re-hydrate the pydantic BaseModel object from Nebula Literal value."""

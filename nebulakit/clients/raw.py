...
import grpc
from nebulaidl.admin.project_pb2 import ProjectListRequest
from nebulaidl.admin.signal_pb2 import SignalList, SignalListRequest, SignalSetRequest, SignalSetResponse
from nebulaidl.service import admin_pb2_grpc as _admin_service
from nebulaidl.service import dataproxy_pb2 as _dataproxy_pb2
from nebulaidl.service import dataproxy_pb2_grpc as dataproxy_service
from nebulaidl.service import signal_pb2_grpc as signal_service
from nebulaidl.service.dataproxy_pb2_grpc import DataProxyServiceStub

from nebulakit.clients.auth_helper import (
    get_channel,
...
class RawSynchronousNebulaClient(object):
    """
    ...
    .. code-block:: python
        ...
        from nebulakit.configuration import PlatformConfig
        RawSynchronousNebulaClient(PlatformConfig(endpoint="a.b.com", insecure=True))  # or
        SynchronousNebulaClient(PlatformConfig(endpoint="a.b.com", insecure=True))
    """
    ...
    def __init__(self, cfg: PlatformConfig, **kwargs):
        """
        Initializes a gRPC channel to the given Nebula Admin service.
        ...
        cli_logger.info(
            f"Nebula Client configured -> {self._cfg.endpoint} in {'insecure' if self._cfg.insecure else 'secure'} mode."
        )
        # metadata will hold the value of the token to send to the various endpoints.
        self._metadata = None

    @classmethod
    def with_root_certificate(cls, cfg: PlatformConfig, root_cert_file: str) -> RawSynchronousNebulaClient:
        b = None
        with open(root_cert_file, "rb") as fp:
            b = fp.read()
        return RawSynchronousNebulaClient(cfg, credentials=grpc.ssl_channel_credentials(root_certificates=b))
    ...
    def create_task(self, task_create_request):
        ...
        :param: nebulaidl.admin.task_pb2.TaskCreateRequest task_create_request: The request protobuf object.
        :rtype: nebulaidl.admin.task_pb2.TaskCreateResponse
        :raises nebulakit.common.exceptions.user.NebulaEntityAlreadyExistsException: If an identical version of the task
    ...
    def list_task_ids_paginated(self, identifier_list_request):
        ...
        :param: nebulaidl.admin.common_pb2.NamedEntityIdentifierListRequest identifier_list_request:
        :rtype: nebulaidl.admin.common_pb2.NamedEntityIdentifierList
        :raises: TODO
        """
    ...
    def list_tasks_paginated(self, resource_list_request):
        ...
        :param: nebulaidl.admin.common_pb2.ResourceListRequest resource_list_request:
        :rtype: nebulaidl.admin.task_pb2.TaskList
        :raises: TODO
        """
    ...
    def get_task(self, get_object_request):
        ...
        :param: nebulaidl.admin.common_pb2.ObjectGetRequest get_object_request:
        :rtype: nebulaidl.admin.task_pb2.Task
        :raises: TODO
        """
    ...
    def create_workflow(self, workflow_create_request):
        ...
        :param: nebulaidl.admin.workflow_pb2.WorkflowCreateRequest workflow_create_request:
        :rtype: nebulaidl.admin.workflow_pb2.WorkflowCreateResponse
    ...
    def list_workflows_paginated(self, resource_list_request):
        ...
        :param: nebulaidl.admin.common_pb2.ResourceListRequest resource_list_request:
        :rtype: nebulaidl.admin.workflow_pb2.WorkflowList
        :raises: TODO
        """
    ...
    def create_launch_plan(self, launch_plan_create_request):
        ...
        :param: nebulaidl.admin.launch_plan_pb2.LaunchPlanCreateRequest launch_plan_create_request:  The request
            protobuf object
        :rtype: nebulaidl.admin.launch_plan_pb2.LaunchPlanCreateResponse
        :raises nebulakit.common.exceptions.user.NebulaEntityAlreadyExistsException: If an identical version of the
    ...
    def get_launch_plan(self, object_get_request):
        ...
        :param nebulaidl.admin.common_pb2.ObjectGetRequest object_get_request:
    ...
    def get_active_launch_plan(self, active_launch_plan_request):
        ...
        :param nebulaidl.admin.common_pb2.ActiveLaunchPlanRequest active_launch_plan_request:
        :rtype: nebulaidl.admin.launch_plan_pb2.LaunchPlan
        """
    ...
    def update_launch_plan(self, update_request):
        ...
        :param nebulaidl.admin.launch_plan_pb2.LaunchPlanUpdateRequest update_request:
        :rtype: nebulaidl.admin.launch_plan_pb2.LaunchPlanUpdateResponse
        """
    ...
    def list_launch_plans_paginated(self, resource_list_request):
        ...
        :param: nebulaidl.admin.common_pb2.ResourceListRequest resource_list_request:
        :rtype: nebulaidl.admin.launch_plan_pb2.LaunchPlanList
        """
    ...
    def list_active_launch_plans_paginated(self, active_launch_plan_list_request):
        ...
        :param: nebulaidl.admin.common_pb2.ActiveLaunchPlanListRequest active_launch_plan_list_request:
        :rtype: nebulaidl.admin.launch_plan_pb2.LaunchPlanList
        """
    ...
    def update_named_entity(self, update_named_entity_request):
        """
        :param nebulaidl.admin.common_pb2.NamedEntityUpdateRequest update_named_entity_request:
        :rtype: nebulaidl.admin.common_pb2.NamedEntityUpdateResponse
        """
    ...
    def create_execution(self, create_execution_request):
        ...
        :param nebulaidl.admin.execution_pb2.ExecutionCreateRequest create_execution_request:
        :rtype: nebulaidl.admin.execution_pb2.ExecutionCreateResponse
        """
    ...
    def recover_execution(self, recover_execution_request):
        ...
        :param nebulaidl.admin.execution_pb2.ExecutionRecoverRequest recover_execution_request:
        :rtype: nebulaidl.admin.execution_pb2.ExecutionRecoverResponse
        """
    ...
    def get_execution(self, get_object_request):
        ...
        :param nebulaidl.admin.execution_pb2.WorkflowExecutionGetRequest get_object_request:
        :rtype: nebulaidl.admin.execution_pb2.Execution
        """
    ...
    def get_execution_data(self, get_execution_data_request):
        ...
        :param nebulaidl.admin.execution_pb2.WorkflowExecutionGetRequest get_execution_data_request:
        :rtype: nebulaidl.admin.execution_pb2.WorkflowExecutionGetDataResponse
        """
    ...
    def get_execution_metrics(self, get_execution_metrics_request):
        ...
        :param nebulaidl.admin.execution_pb2.WorkflowExecutionGetMetricsRequest get_execution_metrics_request:
        :rtype: nebulaidl.admin.execution_pb2.WorkflowExecutionGetMetricsResponse
        """
    ...
    def list_executions_paginated(self, resource_list_request):
        ...
        :param nebulaidl.admin.common_pb2.ResourceListRequest resource_list_request:
        :rtype: nebulaidl.admin.execution_pb2.ExecutionList
        """
    ...
    def terminate_execution(self, terminate_execution_request):
        """
        :param nebulaidl.admin.execution_pb2.TerminateExecutionRequest terminate_execution_request:
        :rtype: nebulaidl.admin.execution_pb2.TerminateExecutionResponse
        """
    ...
    def relaunch_execution(self, relaunch_execution_request):
        """
        :param nebulaidl.admin.execution_pb2.ExecutionRelaunchRequest relaunch_execution_request:
        :rtype: nebulaidl.admin.execution_pb2.ExecutionCreateResponse
        """
    ...
    def get_node_execution(self, node_execution_request):
        """
        :param nebulaidl.admin.node_execution_pb2.NodeExecutionGetRequest node_execution_request:
        :rtype: nebulaidl.admin.node_execution_pb2.NodeExecution
        """
    ...
    def get_node_execution_data(self, get_node_execution_data_request):
        ...
        :param nebulaidl.admin.node_execution_pb2.NodeExecutionGetDataRequest get_node_execution_data_request:
        :rtype: nebulaidl.admin.node_execution_pb2.NodeExecutionGetDataResponse
        """
    ...
    def list_node_executions_paginated(self, node_execution_list_request):
        """
        :param nebulaidl.admin.node_execution_pb2.NodeExecutionListRequest node_execution_list_request:
        :rtype: nebulaidl.admin.node_execution_pb2.NodeExecutionList
        """
    ...
    def list_node_executions_for_task_paginated(self, node_execution_for_task_list_request):
        """
        :param nebulaidl.admin.node_execution_pb2.NodeExecutionListRequest node_execution_for_task_list_request:
        :rtype: nebulaidl.admin.node_execution_pb2.NodeExecutionList
        """
    ...
    def get_task_execution(self, task_execution_request):
        """
        :param nebulaidl.admin.task_execution_pb2.TaskExecutionGetRequest task_execution_request:
    ...
    def get_task_execution_data(self, get_task_execution_data_request):
        ...
        :param nebulaidl.admin.task_execution_pb2.TaskExecutionGetDataRequest get_task_execution_data_request:
        :rtype: nebulaidl.admin.task_execution_pb2.TaskExecutionGetDataResponse
        """
    ...
    def list_task_executions_paginated(self, task_execution_list_request):
        """
        :param nebulaidl.admin.task_execution_pb2.TaskExecutionListRequest task_execution_list_request:
        :rtype: nebulaidl.admin.task_execution_pb2.TaskExecutionList
        """
    ...
    def list_projects(self, project_list_request: typing.Optional[ProjectListRequest] = None):
        """
        This will return a list of the projects registered with the Nebula Admin Service
        :param nebulaidl.admin.project_pb2.ProjectListRequest project_list_request:
        :rtype: nebulaidl.admin.project_pb2.Projects
        """
    ...
    def register_project(self, project_register_request):
        ...
        :param nebulaidl.admin.project_pb2.ProjectRegisterRequest project_register_request:
    ...
    def update_project(self, project):
        ...
        :param nebulaidl.admin.project_pb2.Project project:
    ...
    def update_project_domain_attributes(self, project_domain_attributes_update_request):
        """
        This updates the attributes for a project and domain registered with the Nebula Admin Service
        :param nebulaidl.admin.ProjectDomainAttributesUpdateRequest project_domain_attributes_update_request:
        :rtype: nebulaidl.admin.ProjectDomainAttributesUpdateResponse
        """
    ...
    def update_workflow_attributes(self, workflow_attributes_update_request):
        """
        This updates the attributes for a project, domain, and workflow registered with the Nebula Admin Service
        :param nebulaidl.admin.UpdateWorkflowAttributesRequest workflow_attributes_update_request:
        :rtype: nebulaidl.admin.WorkflowAttributesUpdateResponse
        """
    ...
    def get_project_domain_attributes(self, project_domain_attributes_get_request):
        """
        This fetches the attributes for a project and domain registered with the Nebula Admin Service
        :param nebulaidl.admin.ProjectDomainAttributesGetRequest project_domain_attributes_get_request:
        :rtype: nebulaidl.admin.ProjectDomainAttributesGetResponse
        """
    ...
    def get_workflow_attributes(self, workflow_attributes_get_request):
        """
        This fetches the attributes for a project, domain, and workflow registered with the Nebula Admin Service
        :param nebulaidl.admin.GetWorkflowAttributesAttributesRequest workflow_attributes_get_request:
        :rtype: nebulaidl.admin.WorkflowAttributesGetResponse
        """
    ...
    def list_matchable_attributes(self, matchable_attributes_list_request):
        """
        This fetches the attributes for a specific resource type registered with the Nebula Admin Service
        :param nebulaidl.admin.ListMatchableAttributesRequest matchable_attributes_list_request:
        :rtype: nebulaidl.admin.ListMatchableAttributesResponse
        """
    ...
    def create_upload_location(
        ...
        :param nebulaidl.service.dataproxy_pb2.CreateUploadLocationRequest create_upload_location_request:

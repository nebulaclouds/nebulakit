...
from nebulakitplugins.awssagemaker.models import training_job
...
def test_training_job_resource_config():
    ...
    rc2 = training_job.TrainingJobResourceConfig.from_nebula_idl(rc.to_nebula_idl())
    assert rc2 == rc
...
def test_metric_definition():
    ...
    md2 = training_job.MetricDefinition.from_nebula_idl(md.to_nebula_idl())
    assert md == md2
...
def test_algorithm_specification():
    ...
    alg_spec2 = training_job.AlgorithmSpecification.from_nebula_idl(alg_spec.to_nebula_idl())
...
def test_training_job():
    ...
    tj2 = training_job.TrainingJob.from_nebula_idl(tj.to_nebula_idl())

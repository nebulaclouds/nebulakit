from nebulaidl.core import errors_pb2 as _errors_pb2

from nebulakit.models import common as _common


class ContainerError(_common.NebulaIdlEntity):
    class Kind(object):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.errors_pb2.ContainerError
        """
    ...
    def from_nebula_idl(cls, proto):
        """
        :param nebulaidl.core.errors_pb2.ContainerError proto:
        :rtype: ContainerError
        """
        return cls(proto.code, proto.message, proto.kind, proto.origin)


class ErrorDocument(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.errors_pb2.ErrorDocument
        """
        return _errors_pb2.ErrorDocument(error=self.error.to_nebula_idl())

    @classmethod
    def from_nebula_idl(cls, proto):
        """
        :param nebulaidl.core.errors_pb2.ErrorDocument proto:
        :rtype: ErrorDocument
        """
        return cls(ContainerError.from_nebula_idl(proto.error))

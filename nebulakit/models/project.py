...
class Project(_common.NebulaIdlEntity):
    ...
    def __init__(self, id, name, description, state=ProjectState.ACTIVE):
        """
        A project represents a logical grouping used to organize entities (tasks, workflows, executions) in the Nebula
        platform.
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.admin.project_pb2.Project
        """
    ...
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.admin.project_pb2.Project pb2_object:
        :rtype: Project
        """

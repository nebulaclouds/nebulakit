...
from nebulakit.models.presto import PrestoQuery
...
class AthenaTask(SQLTask[AthenaConfig]):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param query_template: The actual query to run. We use Nebula's Golang templating format for Query templating.

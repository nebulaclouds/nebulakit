...
from nebulakit.core.promise import Promise, VoidPromise, create_and_link_node_from_remote, extract_obj_name
from nebulakit.exceptions import user as user_exceptions
from nebulakit.loggers import remote_logger as logger
from nebulakit.models.core.workflow import NodeMetadata


class RemoteEntity(ABC):
    def __init__(self, *args, **kwargs):
        # In cases where we make a NebulaTask/Workflow/LaunchPlan from a locally created Python object (i.e. an @task

...
from nebulakit.core.base_task import TaskResolverMixin
from nebulakit.core.class_based_resolver import ClassStorageTaskResolver
from nebulakit.core.python_auto_container import default_task_resolver
...
def test_wf_resolving():
    ...
    assert my_wf.location == "tests.nebulakit.unit.core.test_resolver.my_wf"
    ...
    assert srz_t0_spec.template.container.args[-4:] == [
        "--resolver",
        "tests.nebulakit.unit.core.test_resolver.my_wf",
        "--",
        "0",
    ]

...
from nebulakit.clients.auth.token_client import DeviceCodeResponse
...
@patch("nebulakit.clients.auth.authenticator.KeyringStore")
@patch("nebulakit.clients.auth.auth_client.AuthorizationClient.get_creds_from_remote")
@patch("nebulakit.clients.auth.auth_client.AuthorizationClient.refresh_access_token")
...
@patch("nebulakit.clients.auth.token_client.requests.Session")
...
@patch("nebulakit.clients.auth.authenticator.KeyringStore")
@patch("nebulakit.clients.auth.token_client.get_device_code")
@patch("nebulakit.clients.auth.token_client.poll_token_endpoint")

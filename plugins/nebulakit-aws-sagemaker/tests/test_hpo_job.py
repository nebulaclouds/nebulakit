from nebulakitplugins.awssagemaker.models import hpo_job, training_job
...
def test_hyperparameter_tuning_objective():
    ...
    obj2 = hpo_job.HyperparameterTuningObjective.from_nebula_idl(obj.to_nebula_idl())
...
def test_hyperparameter_job_config():
    ...
    jc2 = hpo_job.HyperparameterTuningJobConfig.from_nebula_idl(jc.to_nebula_idl())
...
def test_hyperparameter_tuning_job():
    ...
    hpo2 = hpo_job.HyperparameterTuningJob.from_nebula_idl(hpo.to_nebula_idl())

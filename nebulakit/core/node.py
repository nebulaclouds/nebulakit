...
from nebulakit.core.resources import Resources, convert_resources_to_resource_model
...
from nebulakit.models.task import Resources as _resources_model
...
class Node(object):
    ...
    def __init__(
        ...
        self._nebula_entity = nebula_entity
    ...
    def run_entity(self) -> Any:
        ...
        if isinstance(self.nebula_entity, MapPythonTask):
            return self.nebula_entity.run_task
        if isinstance(self.nebula_entity, ArrayNodeMapTask):
            return self.nebula_entity.python_function_task
        return self.nebula_entity
    ...
    def with_overrides(self, *args, **kwargs):
        ...
        if "requests" in kwargs or "limits" in kwargs:
            ...
            if requests and not isinstance(requests, Resources):
                raise AssertionError("requests should be specified as nebulakit.Resources")
            limits = kwargs.get("limits")
            if limits and not isinstance(limits, Resources):
                raise AssertionError("limits should be specified as nebulakit.Resources")
        ...
        if "accelerator" in kwargs:
            ...
            self._extended_resources = tasks_pb2.ExtendedResources(gpu_accelerator=v.to_nebula_idl())

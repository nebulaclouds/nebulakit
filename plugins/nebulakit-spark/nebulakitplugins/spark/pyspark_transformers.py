...
from nebulakit import Blob, BlobMetadata, BlobType, NebulaContext, Literal, LiteralType, Scalar
from nebulakit.core.type_engine import TypeEngine
from nebulakit.extend import TypeTransformer
...
class PySparkPipelineModelTransformer(TypeTransformer[PipelineModel]):
    ...
    def to_python_value(
        self, ctx: NebulaContext, lv: Literal, expected_python_type: Type[PipelineModel]
    ) -> PipelineModel:

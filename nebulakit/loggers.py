...
LOGGING_ENV_VAR = "NEBULA_SDK_LOGGING_LEVEL"
LOGGING_FMT_ENV_VAR = "NEBULA_SDK_LOGGING_FORMAT"
LOGGING_RICH_FMT_ENV_VAR = "NEBULA_SDK_RICH_TRACEBACKS"

# By default, the root nebulakit logger to debug so everything is logged, but enable fine-tuning
...
nebulakit_root_env_var = f"{LOGGING_ENV_VAR}_ROOT"
level_from_env = os.getenv(LOGGING_ENV_VAR)
root_level_from_env = os.getenv(nebulakit_root_env_var)

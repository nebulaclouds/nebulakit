...
from nebulakitplugins.airflow.task import AirflowObj, _get_airflow_instance

from nebulakit import logger
...
class ResourceMetadata:
    """
    This class is used to store the Airflow task configuration. It is serialized and returned to NebulaPropeller.
    """
...
class AirflowAgent(AgentBase):
    ...
    Operator is invoked in create method. Nebulakit will always set deferrable to True for Operator. Therefore,
    ...
    async def async_get(self, context: grpc.ServicerContext, resource_meta: bytes) -> GetTaskResponse:
        ...
        if isinstance(airflow_operator_instance, BaseSensorOperator):
            ...
            raise NebulaUserException("Only sensor and operator are supported.")

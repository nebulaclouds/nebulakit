from nebulakit.models import matchable_resource
...
def test_cluster_resource_attributes():
    ...
    assert obj == matchable_resource.ClusterResourceAttributes.from_nebula_idl(obj.to_nebula_idl())
...
def test_execution_queue_attributes():
    ...
    assert obj == matchable_resource.ExecutionQueueAttributes.from_nebula_idl(obj.to_nebula_idl())


def test_execution_cluster_label():
    obj = matchable_resource.ExecutionClusterLabel("my_cluster")
    assert obj.value == "my_cluster"
    assert obj == matchable_resource.ExecutionClusterLabel.from_nebula_idl(obj.to_nebula_idl())
...
def test_plugin_override():
    ...
    assert obj == matchable_resource.PluginOverride.from_nebula_idl(obj.to_nebula_idl())
...
def test_plugin_overrides():
    ...
    assert obj == matchable_resource.PluginOverrides.from_nebula_idl(obj.to_nebula_idl())
...
def test_matchable_resource():
    ...
    assert obj == matchable_resource.MatchingAttributes.from_nebula_idl(obj.to_nebula_idl())
    ...
    assert obj2 == matchable_resource.MatchingAttributes.from_nebula_idl(obj2.to_nebula_idl())
    ...
    assert plugin_override_attributes == matchable_resource.MatchingAttributes.from_nebula_idl(
        plugin_override_attributes.to_nebula_idl()
    )

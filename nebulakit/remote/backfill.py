...
from nebulakit.core.workflow import ImperativeWorkflow, WorkflowBase, WorkflowFailurePolicy
from nebulakit.remote.entities import NebulaLaunchPlan


def create_backfill_workflow(
    start_date: datetime,
    end_date: datetime,
    for_lp: typing.Union[LaunchPlan, NebulaLaunchPlan],
    parallel: bool = False,
    ...
    :param for_lp: typing.Union[LaunchPlan, NebulaLaunchPlan] the backfill is generatd for this launchplan
    ...
    schedule = for_lp.entity_metadata.schedule if isinstance(for_lp, NebulaLaunchPlan) else for_lp.schedule

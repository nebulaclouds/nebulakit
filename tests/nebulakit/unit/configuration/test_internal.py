...
from nebulakit.configuration import AuthType, PlatformConfig, get_config_file, read_file_if_exists
from nebulakit.configuration.internal import AWS, Credentials, Images
...
@mock.patch("nebulakit.configuration.file.os")

...
class BigQueryTask(AsyncAgentExecutorMixin, SQLTask[BigQueryConfig]):
    ...
    # https://github.com/nebulaclouds/nebulaplugins/blob/43623826fb189fa64dc4cb53e7025b517d911f22/go/tasks/plugins/webapi/bigquery/plugin.go#L34
    ...
    def __init__(
        ...
        **kwargs,
        ...
        :param query_template: The actual query to run. We use Nebula's Golang templating format for Query templating. Refer to the templating documentation

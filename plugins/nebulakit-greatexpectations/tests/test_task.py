...
def test_ge_remote_nebulafile():
    task_object = GreatExpectationsTask(
        name="test9",
        datasource_name="data",
        inputs=kwtypes(dataset=NebulaFile),
        expectation_suite_name="test.demo",
...
def test_ge_remote_nebulafile_with_task():
    task_object = GreatExpectationsTask(
        name="test10",
        datasource_name="data",
...
def test_ge_remote_nebulafile_workflow():
    task_object = GreatExpectationsTask(
        name="test11",
        datasource_name="data",
        inputs=kwtypes(dataset=CSVFile),
...
def test_ge_nebulafile_workflow():
    task_object = GreatExpectationsTask(
        name="test12",
        datasource_name="data",
        inputs=kwtypes(dataset=CSVFile),
...
def test_ge_nebulafile_multiple_args():
    ...
    @task
    def get_file_name(dataset_one: NebulaFile, dataset_two: NebulaFile) -> typing.Tuple[int, int]:
    ...
    @workflow
    def wf(
        dataset_one: NebulaFile = "https://raw.githubusercontent.com/superconductive/ge_tutorials/main/data/yellow_tripdata_sample_2019-01.csv",
        dataset_two: NebulaFile = "https://raw.githubusercontent.com/superconductive/ge_tutorials/main/data/yellow_tripdata_sample_2019-02.csv",
...
def test_ge_nebulaschema_with_task():
    task_object = GreatExpectationsTask(
        name="test16",
        datasource_name="data",
        inputs=kwtypes(dataset=NebulaSchema),
...
def test_ge_nebulaschema_sqlite():
    task_object = GreatExpectationsTask(
        name="test17",
        datasource_name="data",
        inputs=kwtypes(dataset=NebulaSchema),
    ...
    @workflow
    def my_wf(dataset: NebulaSchema):
        task_object(dataset=dataset)
...
def test_ge_nebulaschema_workflow():
    task_object = GreatExpectationsTask(
        name="test18",
        datasource_name="data",
        inputs=kwtypes(dataset=NebulaSchema),

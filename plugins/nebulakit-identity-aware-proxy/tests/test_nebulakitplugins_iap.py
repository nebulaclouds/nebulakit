...
from nebulakitplugins.identity_aware_proxy.cli import cli, get_gcp_secret_manager_secret, get_service_account_id_token
...
@patch("nebulakitplugins.identity_aware_proxy.cli.id_token.fetch_id_token")

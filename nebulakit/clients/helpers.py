def iterate_node_executions(
    ...
    :param nebulakit.clients.friendly.SynchronousNebulaClient client:
    ...
    :rtype: Iterator[nebulakit.models.node_execution.NodeExecution]
    """
    token = ""
    num_to_fetch = 100
...
def iterate_task_executions(client, node_execution_identifier, limit=None, filters=None):
    ...
    :param int limit: The maximum number of elements to retrieve
    :param list[nebulakit.models.filters.Filter] filters:
    :rtype: Iterator[nebulakit.models.admin.task_execution.TaskExecution]
    """
    token = ""
    num_to_fetch = 100
    if limit is not None and limit < num_to_fetch:

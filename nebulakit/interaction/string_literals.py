...
from nebulakit.models.literals import Literal, LiteralMap, Primitive, Scalar
...
def literal_string_repr(lit: Literal) -> typing.Any:
    ...
    use a shortened string representation of a literal, especially a NebulaFile, NebulaDirectory, or StructuredDataset.
    """
    if lit.scalar:

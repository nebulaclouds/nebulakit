...
def test_identifier():
    ...
    obj2 = identifier.Identifier.from_nebula_idl(obj.to_nebula_idl())
    assert obj2 == obj
...
def test_node_execution_identifier():
    ...
    obj2 = identifier.NodeExecutionIdentifier.from_nebula_idl(obj.to_nebula_idl())
    assert obj2 == obj
...
def test_task_execution_identifier():
    ...
    obj2 = identifier.TaskExecutionIdentifier.from_nebula_idl(obj.to_nebula_idl())
    assert obj2 == obj
...
def test_workflow_execution_identifier():
    ...
    obj2 = identifier.WorkflowExecutionIdentifier.from_nebula_idl(obj.to_nebula_idl())
    assert obj2 == obj
    assert obj2.project == "project"
    assert obj2.domain == "domain"
    assert obj2.name == "name"

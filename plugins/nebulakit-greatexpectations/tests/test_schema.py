...
def test_ge_type():
    ge_config = GreatExpectationsNebulaConfig(
...
def test_ge_schema_multiple_args():
    ge_config_one = GreatExpectationsNebulaConfig(
        datasource_name="data",
        expectation_suite_name="test.demo",
        data_connector_name="data_example_data_connector",
    )
    ge_config_two = GreatExpectationsNebulaConfig(
        datasource_name="data",
...
def test_ge_runtimebatchrequest_pandas_config():
    ...
    @task
    def my_task(pandas_df: GreatExpectationsType[NebulaSchema, ge_config]) -> int:
...
def test_ge_schema_nebulaschema():
    @task
    def my_task(
    ...
    @workflow
    def valid_wf(dataframe: NebulaSchema) -> int:
...
def test_ge_schema_nebulaschema_literal():
    @task
    def my_task(
        dataframe: GreatExpectationsType[
            NebulaSchema,
...
def test_ge_schema_remote_nebulafile():
    ge_config = GreatExpectationsNebulaConfig(
        datasource_name="data",
        expectation_suite_name="test.demo",
        data_connector_name="data_nebulatype_data_connector",
...
def test_ge_schema_remote_nebulafile_literal():
    ge_config = GreatExpectationsNebulaConfig(
        datasource_name="data",
        expectation_suite_name="test.demo",
        data_connector_name="data_nebulatype_data_connector",

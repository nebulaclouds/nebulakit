"""
This Plugin adds the capability of running distributed MPI training to Nebula using backend plugins, natively on
...
from nebulaidl.plugins.kubeflow import mpi_pb2 as mpi_task
...
# Register the MPI Plugin into the nebulakit core plugin system

from nebulaidl.core import condition_pb2 as _condition

from nebulakit.models import common as _common
from nebulakit.models import literals as _literals


class ComparisonExpression(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.condition_pb2.ComparisonExpression
        """
        return _condition.ComparisonExpression(
            operator=self.operator,
            left_value=self.left_value.to_nebula_idl(),
            right_value=self.right_value.to_nebula_idl(),
        )
    ...
    def from_nebula_idl(cls, pb2_object):
        return cls(
            ...
            left_value=Operand.from_nebula_idl(pb2_object.left_value),
            right_value=Operand.from_nebula_idl(pb2_object.right_value),
        )


class ConjunctionExpression(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.condition_pb2.ConjunctionExpression
        """
        return _condition.ConjunctionExpression(
            operator=self.operator,
            left_expression=self.left_expression.to_nebula_idl(),
            right_expression=self.right_expression.to_nebula_idl(),
        )
    ...
    def from_nebula_idl(cls, pb2_object):
        return cls(
            operator=pb2_object.operator,
            left_expression=BooleanExpression.from_nebula_idl(pb2_object.left_expression),
            right_expression=BooleanExpression.from_nebula_idl(pb2_object.right_expression),
        )


class Operand(_common.NebulaIdlEntity):
    def __init__(self, primitive=None, var=None, scalar=None):
        """
        Defines an operand to a comparison expression.
        :param nebulakit.models.literals.Primitive primitive: A primitive value
        :param Text var: A variable name
        :param nebulakit.models.literals.Scalar scalar: A scalar value
        """
    ...
    def primitive(self):
        """
        :rtype: nebulakit.models.literals.Primitive
        """
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.condition_pb2.Operand
        """
        return _condition.Operand(
            primitive=self.primitive.to_nebula_idl() if self.primitive else None,
            var=self.var if self.var else None,
            scalar=self.scalar.to_nebula_idl() if self.scalar else None,
        )

    @classmethod
    def from_nebula_idl(cls, pb2_object):
        return cls(
            primitive=_literals.Primitive.from_nebula_idl(pb2_object.primitive)
            if pb2_object.HasField("primitive")
            else None,
            var=pb2_object.var if pb2_object.HasField("var") else None,
            scalar=_literals.Scalar.from_nebula_idl(pb2_object.scalar) if pb2_object.HasField("scalar") else None,
        )


class BooleanExpression(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.core.condition_pb2.BooleanExpression
        """
        return _condition.BooleanExpression(
            conjunction=self.conjunction.to_nebula_idl() if self.conjunction else None,
            comparison=self.comparison.to_nebula_idl() if self.comparison else None,
        )

    @classmethod
    def from_nebula_idl(cls, pb2_object):
        return cls(
            conjunction=ConjunctionExpression.from_nebula_idl(pb2_object.conjunction)
            if pb2_object.HasField("conjunction")
            else None,
            comparison=ComparisonExpression.from_nebula_idl(pb2_object.comparison)

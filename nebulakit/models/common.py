...
class NebulaABCMeta(_abc.ABCMeta):
    def __instancecheck__(cls, instance):
        if cls in type(instance).__mro__:
            return True
        return super(NebulaABCMeta, cls).__instancecheck__(instance)


class NebulaType(NebulaABCMeta):
    def __repr__(cls):
    ...
    def short_class_string(cls):
        ...
        :rtype: Text
        """
        return super(NebulaType, cls).__repr__()
    ...
    @_abc.abstractmethod
    def from_nebula_idl(cls, idl_object):
        pass


class NebulaIdlEntity(object, metaclass=NebulaType):
    def __eq__(self, other):
        return isinstance(other, NebulaIdlEntity) and other.to_nebula_idl() == self.to_nebula_idl()
    ...
    def __hash__(self):
        return hash(self.to_nebula_idl().SerializeToString(deterministic=True))

    def short_string(self):
        """
        :rtype: Text
        """
        literal_str = re.sub(r"\s+", " ", str(self.to_nebula_idl())).strip()
        return f"<NebulaLiteral {literal_str}>"
    ...
    def serialize_to_string(self) -> str:
        return self.to_nebula_idl().SerializeToString()

    @property
    def is_empty(self):
        return len(self.to_nebula_idl().SerializeToString()) == 0
...
class NebulaCustomIdlEntity(NebulaIdlEntity):
    @classmethod
    def from_nebula_idl(cls, idl_object):
        """

        :param _struct.Struct idl_object:
        :return: NebulaCustomIdlEntity
        """
...
class NamedEntityIdentifier(NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        Stores object to a Nebula-IDL defined protobuf.
        :rtype: nebulaidl.admin.common_pb2.NamedEntityIdentifier
        """
    ...
    def from_nebula_idl(cls, idl_object):
        """
        :param nebulaidl.admin.common_pb2.NamedEntityIdentifier idl_object:
        :rtype: NamedEntityIdentifier
        """
        return cls(idl_object.project, idl_object.domain, idl_object.name)


class EmailNotification(NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.admin.common_pb2.EmailNotification
        """
    ...
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.admin.common_pb2.EmailNotification pb2_object:
        :rtype: EmailNotification
        """
        return cls(pb2_object.recipients_email)


class SlackNotification(NebulaIdlEntity):
    def __init__(self, recipients_email):
        """
        :param list[Text] recipients_email:
        """
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.admin.common_pb2.SlackNotification
        """
    ...
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.admin.common_pb2.SlackNotification pb2_object:
        :rtype: EmailNotification
        """
        return cls(pb2_object.recipients_email)


class PagerDutyNotification(NebulaIdlEntity):
    def __init__(self, recipients_email):
        """
        :param list[Text] recipients_email:
        """
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.admin.common_pb2.PagerDutyNotification
        """
    ...
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.admin.common_pb2.PagerDutyNotification pb2_object:
        :rtype: EmailNotification
        """
        return cls(pb2_object.recipients_email)


class Notification(NebulaIdlEntity):
    def __init__(
        self,
        phases,
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.admin.common_pb2.Notification
        """
        return _common_pb2.Notification(
            phases=self.phases,
            email=self.email.to_nebula_idl() if self.email else None,
            pager_duty=self.pager_duty.to_nebula_idl() if self.pager_duty else None,
            slack=self.slack.to_nebula_idl() if self.slack else None,
        )

    @classmethod
    def from_nebula_idl(cls, p):
        """
        :param nebulaidl.admin.common_pb2.Notification p:
        :rtype: Notification
        """
        return cls(
            p.phases,
            email=EmailNotification.from_nebula_idl(p.email) if p.HasField("email") else None,
            pager_duty=PagerDutyNotification.from_nebula_idl(p.pager_duty) if p.HasField("pager_duty") else None,
            slack=SlackNotification.from_nebula_idl(p.slack) if p.HasField("slack") else None,
        )


class Labels(NebulaIdlEntity):
    ...
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.admin.common_pb2.Labels pb2_object:
        :rtype: Labels
        """
        return cls({k: v for k, v in pb2_object.values.items()})


class Annotations(NebulaIdlEntity):
    def __init__(self, values):
        """
    ...
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.admin.common_pb2.Annotations pb2_object:
        :rtype: Annotations
        """
        return cls({k: v for k, v in pb2_object.values.items()})


class UrlBlob(NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.admin.common_pb2.UrlBlob
        """
    ...
    def from_nebula_idl(cls, pb):
        """
        :param nebulaidl.admin.common_pb2.UrlBlob pb:
        :rtype: UrlBlob
        """
        return cls(url=pb.url, bytes=pb.bytes)


class AuthRole(NebulaIdlEntity):
    def __init__(self, assumable_iam_role=None, kubernetes_service_account=None):
        ...
        :param Text kubernetes_service_account: Provides an identity for workflow execution resources.
          Nebula deployment administrators are responsible for handling permissions as they
...
class RawOutputDataConfig(NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.admin.common_pb2.Auth
        """
...
class Envs(NebulaIdlEntity):
    ...
    def to_nebula_idl(self) -> _common_pb2.Envs:
        return _common_pb2.Envs(values=[_literals_pb2.KeyValuePair(key=k, value=v) for k, v in self.envs.items()])

    @classmethod
    def from_nebula_idl(cls, pb2: _common_pb2.Envs) -> _common_pb2.Envs:

...
from nebulakitplugins.whylogs.schema import WhylogsDatasetProfileTransformer
...
def test_to_html_method() -> None:
    ...
    profile_view = whylogs_profiling()
    report = tf.to_html(NebulaContextManager.current_context(), profile_view, Type[DatasetProfileView])

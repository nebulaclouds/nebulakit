...
def test_retry_strategy():
    ...
    assert literals.RetryStrategy.from_nebula_idl(obj.to_nebula_idl()) == obj
...
def test_void():
    obj = literals.Void()
    assert literals.Void.from_nebula_idl(obj.to_nebula_idl()) == obj
...
def test_integer_primitive():
    ...
    obj2 = literals.Primitive.from_nebula_idl(obj.to_nebula_idl())
    assert obj == obj2
    ...
    with pytest.raises(Exception):
        literals.Primitive(integer=1.0).to_nebula_idl()
...
def test_boolean_primitive():
    ...
    with pytest.raises(Exception):
        literals.Primitive(boolean=datetime.now()).to_nebula_idl()
...
def test_datetime_primitive():
    ...
    with pytest.raises(Exception):
        literals.Primitive(datetime=1.0).to_nebula_idl()
...
def test_duration_primitive():
    ...
    with pytest.raises(Exception):
        literals.Primitive(duration=1.0).to_nebula_idl()
...
def test_float_primitive():
    ...
    with pytest.raises(Exception):
        literals.Primitive(float_value="abc").to_nebula_idl()
...
def test_string_primitive():
    ...
    with pytest.raises(Exception):
        literals.Primitive(string_value=1.0).to_nebula_idl()
...
def test_scalar_primitive():
    ...
    obj2 = literals.Scalar.from_nebula_idl(obj.to_nebula_idl())
    assert obj2 == obj
...
def test_binding_data_scalar():
    ...
    obj2 = literals.BindingData.from_nebula_idl(obj.to_nebula_idl())
    assert obj == obj2
...
def test_scalar_literals(scalar_value_pair):
    ...
    obj2 = literals.Literal.from_nebula_idl(obj.to_nebula_idl())
    assert obj == obj2
...
def test_literal_collection(literal_value_pair):
    ...
    obj2 = literals.LiteralCollection.from_nebula_idl(obj.to_nebula_idl())
    assert obj == obj2
    assert all(ll == lit for ll in obj.literals)
    assert len(obj.literals) == 3

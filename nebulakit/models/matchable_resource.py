from nebulaidl.admin import matchable_resource_pb2 as _matchable_resource
...
class ClusterResourceAttributes(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.admin.matchable_resource_pb2.ClusterResourceAttributes
        """
    ...
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.admin.matchable_resource_pb2.ClusterResourceAttributes pb2_object:
...
class ExecutionQueueAttributes(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.admin.matchable_resource_pb2.ExecutionQueueAttributes
        """
    ...
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.admin.matchable_resource_pb2.ExecutionQueueAttributes pb2_object:
...
class ExecutionClusterLabel(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.admin.matchable_resource_pb2.ExecutionClusterLabel
        """
    ...
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.admin.matchable_resource_pb2.ExecutionClusterLabel pb2_object:
...
class PluginOverride(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.admin.matchable_resource_pb2.PluginOverride
        """
    ...
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.admin.matchable_resource_pb2.PluginOverride pb2_object:
...
class PluginOverrides(_common.NebulaIdlEntity):
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.admin.matchable_resource_pb2.PluginOverrides
        """
        return _matchable_resource.PluginOverrides(overrides=[override.to_nebula_idl() for override in self.overrides])

    @classmethod
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.admin.matchable_resource_pb2.PluginOverrides pb2_object:
        :rtype: PluginOverrides
        """
        return cls(overrides=[PluginOverride.from_nebula_idl(override) for override in pb2_object.overrides])


class MatchingAttributes(_common.NebulaIdlEntity):
    def __init__(
        self,
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.admin.matchable_resource_pb2.MatchingAttributes
        """
        return _matchable_resource.MatchingAttributes(
            cluster_resource_attributes=self.cluster_resource_attributes.to_nebula_idl()
            if self.cluster_resource_attributes
            else None,
            execution_queue_attributes=self.execution_queue_attributes.to_nebula_idl()
            if self.execution_queue_attributes
            else None,
            execution_cluster_label=self.execution_cluster_label.to_nebula_idl()
            if self.execution_cluster_label
            else None,
            plugin_overrides=self.plugin_overrides.to_nebula_idl() if self.plugin_overrides else None,
        )

    @classmethod
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.admin.matchable_resource_pb2.MatchingAttributes pb2_object:
        :rtype: MatchingAttributes
        """
        return cls(
            cluster_resource_attributes=ClusterResourceAttributes.from_nebula_idl(pb2_object.cluster_resource_attributes)
            if pb2_object.HasField("cluster_resource_attributes")
            else None,
            execution_queue_attributes=ExecutionQueueAttributes.from_nebula_idl(pb2_object.execution_queue_attributes)
            if pb2_object.HasField("execution_queue_attributes")
            else None,
            execution_cluster_label=ExecutionClusterLabel.from_nebula_idl(pb2_object.execution_cluster_label)
            if pb2_object.HasField("execution_cluster_label")
            else None,
            plugin_overrides=PluginOverrides.from_nebula_idl(pb2_object.plugin_overrides)

...
from nebulakit.core.task import TaskMetadata
from nebulakit.experimental import map_task as array_node_map_task
...
def test_serialization(serialization_settings):
    ...
    assert task_spec.template.container.args == [
        ...
        "task-module",
        "tests.nebulakit.unit.core.test_array_node_map_task",
        "task-name",
        "t1",
    ]
...
def test_inputs_outputs_length():
    ...
    assert (
        m.name
        == "tests.nebulakit.unit.core.test_array_node_map_task.map_many_inputs_4ee240ef5cf979dbc133fb30035cb874-arraynode"
    )
    ...
    assert (
        m.name
        == "tests.nebulakit.unit.core.test_array_node_map_task.map_many_inputs_352fcdea8523a83134b51bbf5793f14e-arraynode"
    )
    ...
    assert (
        m.name
        == "tests.nebulakit.unit.core.test_array_node_map_task.map_many_inputs_e224ba3a5b00e08083d541a6ca99b179-arraynode"
    )
    ...
    assert (
        m.name
        == "tests.nebulakit.unit.core.test_array_node_map_task.map_many_inputs_f080e60be9d6faedeef0c74834d6812a-arraynode"
    )

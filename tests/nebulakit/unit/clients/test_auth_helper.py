...
import pytest
import requests
from nebulaidl.service.auth_pb2 import OAuth2MetadataResponse, PublicClientAuthConfigResponse
...
from nebulakit.clients.auth.exceptions import AuthenticationError
...
def get_auth_service_mock() -> MagicMock:
    ...
    auth_stub_mock.GetPublicClientConfig.return_value = PublicClientAuthConfigResponse(
        ...
        scopes=["offline", "all"],
        authorization_metadata_key="nebula-authorization",
    )
...
@patch("nebulakit.clients.auth_helper.AuthMetadataServiceStub")
...
def test_get_proxy_authenticated_session():
    ...
    platform_config = PlatformConfig(
        endpoint="http://my-nebula-deployment.com",

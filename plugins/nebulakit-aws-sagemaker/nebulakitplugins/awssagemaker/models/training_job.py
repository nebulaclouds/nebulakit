...
from nebulaidl.plugins.sagemaker import training_job_pb2 as _training_job_pb2
...
class TrainingJobResourceConfig(_common.NebulaIdlEntity):
    """
    ...
    def to_nebula_idl(self) -> _training_job_pb2.TrainingJobResourceConfig:
        """
    ...
    @classmethod
    def from_nebula_idl(cls, pb2_object: _training_job_pb2.TrainingJobResourceConfig):
        """
...
class MetricDefinition(_common.NebulaIdlEntity):
    def __init__(
        self,
        name: str,
        regex: str,
    ...
    def to_nebula_idl(self) -> _training_job_pb2.MetricDefinition:
        """
    ...
    @classmethod
    def from_nebula_idl(cls, pb2_object: _training_job_pb2.MetricDefinition):
        """
...
class AlgorithmSpecification(_common.NebulaIdlEntity):
    """
    ...
    def to_nebula_idl(self) -> _training_job_pb2.AlgorithmSpecification:
        return _training_job_pb2.AlgorithmSpecification(
            input_mode=self.input_mode,
            algorithm_name=self.algorithm_name,
            algorithm_version=self.algorithm_version,
            metric_definitions=[m.to_nebula_idl() for m in self.metric_definitions],
            input_content_type=self.input_content_type,
        )

    @classmethod
    def from_nebula_idl(cls, pb2_object: _training_job_pb2.AlgorithmSpecification):
        return cls(
            input_mode=pb2_object.input_mode,
            algorithm_name=pb2_object.algorithm_name,
            algorithm_version=pb2_object.algorithm_version,
            metric_definitions=[MetricDefinition.from_nebula_idl(m) for m in pb2_object.metric_definitions],
            input_content_type=pb2_object.input_content_type,
        )


class TrainingJob(_common.NebulaIdlEntity):
    def __init__(
        self,
    ...
    def to_nebula_idl(self) -> _training_job_pb2.TrainingJob:
        """
        :rtype: _training_job_pb2.TrainingJob
        """

        return _training_job_pb2.TrainingJob(
            algorithm_specification=self.algorithm_specification.to_nebula_idl()
            if self.algorithm_specification
            else None,
            training_job_resource_config=self.training_job_resource_config.to_nebula_idl()
            if self.training_job_resource_config
            else None,
        )

    @classmethod
    def from_nebula_idl(cls, pb2_object: _training_job_pb2.TrainingJob):
        """

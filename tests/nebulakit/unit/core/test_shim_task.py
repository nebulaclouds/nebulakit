...
from nebulakit import ContainerTask, Resources, kwtypes
from nebulakit.configuration import Image, ImageConfig
from nebulakit.core.python_customized_container_task import PythonCustomizedContainerTask, TaskTemplateResolver
from nebulakit.core.utils import write_proto_to_file
...
def test_resolver_load_task():
    ...
    write_proto_to_file(ts.template.to_nebula_idl(), file)
...
@mock.patch("nebulakit.core.python_customized_container_task.PythonCustomizedContainerTask.get_config")
@mock.patch("nebulakit.core.python_customized_container_task.PythonCustomizedContainerTask.get_custom")

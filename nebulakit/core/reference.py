...
from nebulakit.core.launch_plan import ReferenceLaunchPlan
from nebulakit.core.task import ReferenceTask
from nebulakit.core.workflow import ReferenceWorkflow
...
def get_reference_entity(
    ...
    """
    See the documentation for :py:class:`nebulakit.reference_task` and :py:class:`nebulakit.reference_workflow` as well.
    ...
    :param resource_type: This is the type of entity it is. Must be one of
      :py:class:`nebulakit.models.core.identifier.ResourceType`
    ...
    if resource_type == _identifier_model.ResourceType.TASK:
        ...
        raise NebulaValidationException("Resource type must be one of task, workflow, or launch plan")

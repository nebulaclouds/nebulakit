from nebulaidl.plugins.sagemaker import hyperparameter_tuning_job_pb2 as _pb2_hpo_job
...
class HyperparameterTuningObjective(_common.NebulaIdlEntity):
    """
    ...
    def to_nebula_idl(self) -> _pb2_hpo_job.HyperparameterTuningObjective:
    ...
    @classmethod
    def from_nebula_idl(cls, pb2_object: _pb2_hpo_job.HyperparameterTuningObjective):
        return cls(
...
class HyperparameterTuningJobConfig(_common.NebulaIdlEntity):
    """
    ...
    def to_nebula_idl(self) -> _pb2_hpo_job.HyperparameterTuningJobConfig:
        return _pb2_hpo_job.HyperparameterTuningJobConfig(
            tuning_strategy=self._tuning_strategy,
            tuning_objective=self._tuning_objective.to_nebula_idl(),
            training_job_early_stopping_type=self._training_job_early_stopping_type,
        )

    @classmethod
    def from_nebula_idl(cls, pb2_object: _pb2_hpo_job.HyperparameterTuningJobConfig):
        return cls(
            tuning_strategy=pb2_object.tuning_strategy,
            tuning_objective=HyperparameterTuningObjective.from_nebula_idl(pb2_object.tuning_objective),
            training_job_early_stopping_type=pb2_object.training_job_early_stopping_type,
        )


class HyperparameterTuningJob(_common.NebulaIdlEntity):
    def __init__(
        self,
    ...
    def to_nebula_idl(self) -> _pb2_hpo_job.HyperparameterTuningJob:
        return _pb2_hpo_job.HyperparameterTuningJob(
            ...
            training_job=self._training_job.to_nebula_idl(),  # SDK task has already serialized it
        )

    @classmethod
    def from_nebula_idl(cls, pb2_object: _pb2_hpo_job.HyperparameterTuningJob):
        return cls(
            ...
            training_job=_training_job.TrainingJob.from_nebula_idl(pb2_object.training_job),
        )

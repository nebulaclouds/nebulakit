...
from nebulakit.clis.sdk_in_container.run import RunCommand, RunLevelParams, WorkflowCommand
from nebulakit.clis.sdk_in_container.utils import make_click_option_field
from nebulakit.configuration import ImageConfig, SerializationSettings
from nebulakit.core.base_task import PythonTask
from nebulakit.core.workflow import PythonFunctionWorkflow
...
def build_command(ctx: click.Context, entity: typing.Union[PythonFunctionWorkflow, PythonTask]):
    """
    Returns a function that is used to implement WorkflowCommand and build an image for nebula workflows.
    """
...
class BuildCommand(RunCommand):
    """
    A click command group for building a image for nebula workflows & tasks in a file.
    """

...
from nebulakit import NebulaContext, NebulaContextManager, kwtypes, task, workflow
...
from nebulakit.types.structured.basic_dfs import CSVToPandasDecodingHandler, PandasToCSVEncodingHandler
...
PANDAS_PATH = NebulaContextManager.current_context().file_access.get_random_local_directory()
NUMPY_PATH = NebulaContextManager.current_context().file_access.get_random_local_directory()
BQ_PATH = "bq://nebula-dataset:nebula.table"

...
from nebulakit.core import workflow as _annotated_workflow
from nebulakit.core.context_manager import NebulaContext, NebulaContextManager, NebulaEntities
from nebulakit.core.interface import Interface, transform_function_to_interface, transform_inputs_to_parameters
from nebulakit.core.promise import create_and_link_node, translate_inputs_to_literals
from nebulakit.core.reference_entity import LaunchPlanReference, ReferenceEntity
...
from nebulakit.models import schedule as _schedule_model
...
class LaunchPlan(object):
    """
    Launch Plans are one of the core constructs of Nebula. Please take a look at the discussion in the
    :std:ref:`core concepts <nebula:divedeep-launchplans>` if you are unfamiliar with them.
    ...
    .. literalinclude:: ../../../tests/nebulakit/unit/core/test_launch_plan.py
    ...
    .. code-block:: python
        ...
        from nebulakit.models.common import Annotations, AuthRole, Labels, RawOutputDataConfig
    ...
    @staticmethod
    def get_default_launch_plan(ctx: NebulaContext, workflow: _annotated_workflow.WorkflowBase) -> LaunchPlan:
        """
        ...
        :param ctx: This is not nebulakit.current_context(). This is an internal context object. Users familiar with
          nebulakit should feel free to use this however.
    ...
    def create(
        ...
        fixed_literals = translate_inputs_to_literals(
            ...
            nebula_interface_types=workflow.interface.inputs,
...
class ReferenceLaunchPlan(ReferenceEntity, LaunchPlan):
    """
    A reference launch plan serves as a pointer to a Launch Plan that already exists on your Nebula installation. This
...
def reference_launch_plan(
    ...
    """
    A reference launch plan is a pointer to a launch plan that already exists on your Nebula installation. This
    object will not initiate a network call to Admin, which is why the user is asked to provide the expected interface
    via the function definition.

    If at registration time the interface provided causes an issue with compilation, an error will be returned.

    :param project: Nebula project name of the launch plan
    :param domain: Nebula domain name of the launch plan

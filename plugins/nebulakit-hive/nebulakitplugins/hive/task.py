...
from nebulakit.extend import SQLTask
from nebulakit.models.qubole import HiveQuery, QuboleHiveJob
...
class HiveTask(SQLTask[HiveConfig]):
    ...
    def __init__(
        ...
        output_schema_type: Optional[Type[NebulaSchema]] = None,
        **kwargs,
    ):
        """
        Args:
            ...
            query_template: The actual query to run. We use Nebula's Golang templating format for Query templating.
    ...
    @property
    def output_schema_type(self) -> Optional[Type[NebulaSchema]]:
...
class HiveSelectTask(HiveTask):
    ...
    def __init__(
        ...
        output_schema_type: Optional[Type[NebulaSchema]] = None,  # Should default to a generic schema object?

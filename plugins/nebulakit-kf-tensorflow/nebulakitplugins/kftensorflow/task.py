"""
This Plugin adds the capability of running distributed tensorflow training to Nebula using backend plugins, natively on
...
from nebulaidl.plugins.kubeflow import tensorflow_pb2 as tensorflow_task

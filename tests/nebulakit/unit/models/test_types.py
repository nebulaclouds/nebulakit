import pytest
from nebulaidl.core import types_pb2
...
def test_schema_type():
    ...
    assert obj == _types.SchemaType.from_nebula_idl(obj.to_nebula_idl())
...
def test_literal_types():
    ...
    assert obj == _types.LiteralType.from_nebula_idl(obj.to_nebula_idl())
...
def test_output_reference():
    ...
    assert obj.var == "var1"
    obj2 = _types.OutputReference.from_nebula_idl(obj.to_nebula_idl())
    assert obj == obj2

...
from nebulaidl.core import workflow_pb2 as _workflow_pb2

from nebulakit.models import literals as _literals
from nebulakit.models import task as _task_model
from nebulakit.models.core import compiler as _compiler_model
...
def get_sample_node_metadata(node_id):
    """
    :param Text node_id:
    :rtype: nebulakit.models.core.workflow.NodeMetadata
    """
...
def get_sample_container():
    """
    :rtype: nebulakit.models.task.Container
    """
...
def get_sample_task_metadata():
    """
    :rtype: nebulakit.models.task.TaskMetadata
    """
    return _task_model.TaskMetadata(
        True,
        _task_model.RuntimeMetadata(_task_model.RuntimeMetadata.RuntimeType.NEBULA_SDK, "1.0.0", "python"),
        timedelta(days=1),
...
def get_workflow_template():
    ...
    It was created by reading from Nebula Admin, the following workflow, after registration.

    from nebulakit.common.types.primitives import Integer
    ...
    from nebulakit.sdk.workflow import workflow_class, Input, Output
    ...
    wt = _workflow_model.WorkflowTemplate.from_nebula_idl(workflow_template_pb)
    return wt
...
def get_compiled_workflow_closure():
    ...
    return _compiler_model.CompiledWorkflowClosure.from_nebula_idl(cwc_pb)

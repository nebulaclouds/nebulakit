from nebulakit.models.core import errors, execution
...
def test_container_error():
    ...
    obj2 = errors.ContainerError.from_nebula_idl(obj.to_nebula_idl())
    assert obj == obj2
...
def test_error_document():
    ...
    obj2 = errors.ErrorDocument.from_nebula_idl(obj.to_nebula_idl())
    assert obj == obj2

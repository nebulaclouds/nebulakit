...
def test_long_description():
    ...
    assert Description.from_nebula_idl(obj.to_nebula_idl()) == obj
...
def test_source_code():
    link = "https://github.com/nebulaclouds/nebulakit"
    obj = SourceCode(link=link)
    assert SourceCode.from_nebula_idl(obj.to_nebula_idl()) == obj
...
def test_documentation():
    ...
    assert Documentation.from_nebula_idl(obj.to_nebula_idl()) == obj

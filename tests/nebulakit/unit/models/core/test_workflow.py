...
def test_node_metadata():
    ...
    obj2 = _workflow.NodeMetadata.from_nebula_idl(obj.to_nebula_idl())
    assert obj == obj2
...
def test_alias():
    ...
    obj2 = _workflow.Alias.from_nebula_idl(obj.to_nebula_idl())
    assert obj == obj2
...
def test_workflow_template():
    ...
    obj2 = _workflow.WorkflowTemplate.from_nebula_idl(obj.to_nebula_idl())
    assert obj2 == obj
...
def test_workflow_metadata_failure_policy():
    ...
    obj2 = _workflow.WorkflowMetadata.from_nebula_idl(obj.to_nebula_idl())
    assert obj == obj2
...
def test_task_node():
    ...
    obj2 = _workflow.TaskNode.from_nebula_idl(obj.to_nebula_idl())
    assert obj == obj2
...
def test_workflow_node_lp():
    ...
    obj2 = _workflow.WorkflowNode.from_nebula_idl(obj.to_nebula_idl())
    assert obj == obj2
...
def test_node_task_with_no_inputs():
    ...
    obj2 = _workflow.Node.from_nebula_idl(obj.to_nebula_idl())
    assert obj == obj2
...
def test_branch_node():
    ...
    bn2 = _workflow.BranchNode.from_nebula_idl(bn.to_nebula_idl())
    assert bn == bn2
...
def test_task_node_overrides():
    overrides = _workflow.TaskNodeOverrides(
        ...
        tasks_pb2.ExtendedResources(gpu_accelerator=T4.to_nebula_idl()),
    )
    ...
    assert overrides.extended_resources.gpu_accelerator == T4.to_nebula_idl()

    obj = _workflow.TaskNodeOverrides.from_nebula_idl(overrides.to_nebula_idl())
...
def test_task_node_with_overrides():
    ...
    assert task_node.overrides.extended_resources.gpu_accelerator == T4.to_nebula_idl()

    obj = _workflow.TaskNode.from_nebula_idl(task_node.to_nebula_idl())

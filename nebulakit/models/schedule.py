from nebulaidl.admin import schedule_pb2 as _schedule_pb2

from nebulakit.models import common as _common


class Schedule(_common.NebulaIdlEntity):
    ...
    class FixedRate(_common.NebulaIdlEntity):
        ...
        def to_nebula_idl(self):
            """
            :rtype: nebulaidl.admin.schedule_pb2.FixedRate
            """
        ...
        def from_nebula_idl(cls, pb2_object):
            """
            :param nebulaidl.admin.schedule_pb2.FixedRate pb2_object:
            :rtype: Schedule.FixedRate
            """
            return cls(pb2_object.value, pb2_object.unit)

    class CronSchedule(_common.NebulaIdlEntity):
        ...
        def from_nebula_idl(cls, pb2_object):
            """
            :param nebulaidl.admin.schedule_pb2.CronSchedule pb2_object:
    ...
    def to_nebula_idl(self):
        """
        :rtype: nebulaidl.admin.schedule_pb2.Schedule
        """
        return _schedule_pb2.Schedule(
            kickoff_time_input_arg=self.kickoff_time_input_arg,
            cron_expression=self.cron_expression,
            rate=self.rate.to_nebula_idl() if self.rate is not None else None,
            cron_schedule=self.cron_schedule.to_nebula_idl() if self.cron_schedule is not None else None,
        )

    @classmethod
    def from_nebula_idl(cls, pb2_object):
        """
        :param nebulaidl.admin.schedule_pb2.Schedule pb2_object:
        :rtype: Schedule
        """
        ...
        return Schedule(
            ...
            rate=Schedule.FixedRate.from_nebula_idl(pb2_object.rate) if pb2_object.HasField("rate") else None,
            cron_schedule=Schedule.CronSchedule.from_nebula_idl(pb2_object.cron_schedule)
